    ...
    if ($action === "WRITE") { // ADD SALES RECEIPT
          ...
          if ($is_lunas === 1) {
            ...
            if ($status_ar === 'notyet') {
              $sql4 = "UPDATE pro_customer_admin_arnya
                            SET not_yet = ((not_yet - '" . floatval($bayar) . "') + '" . floatval($res_invoice['total_bayar']) . "')
                          WHERE id_customer = '" . addslashes($res_invoice['id_customer']) . "'";
            } else if ($status_ar === 'ov_up_07') {
              $sql4 = "UPDATE pro_customer_admin_arnya
                            SET ov_up_07 = ((ov_up_07 - '" . floatval($bayar) . "') + '" . floatval($res_invoice['total_bayar']) . "')
                          WHERE id_customer = '" . addslashes($res_invoice['id_customer']) . "'";
            } else if ($status_ar === 'ov_under_30') {
              $sql4 = "UPDATE pro_customer_admin_arnya
                            SET ov_under_30 = ((ov_under_30 - '" . floatval($bayar) . "') + '" . floatval($res_invoice['total_bayar']) . "')
                          WHERE id_customer = '" . addslashes($res_invoice['id_customer']) . "'";
            } else if ($status_ar === 'ov_under_60') {
              $sql4 = "UPDATE pro_customer_admin_arnya
                            SET ov_under_60 = ((ov_under_60 - '" . floatval($bayar) . "') + '" . floatval($res_invoice['total_bayar']) . "')
                          WHERE id_customer = '" . addslashes($res_invoice['id_customer']) . "'";
            } else if ($status_ar === 'ov_under_90') {
              $sql4 = "UPDATE pro_customer_admin_arnya
                            SET ov_under_90 = ((ov_under_90 - '" . floatval($bayar) . "') + '" . floatval($res_invoice['total_bayar']) . "')
                          WHERE id_customer = '" . addslashes($res_invoice['id_customer']) . "'";
            } else if ($status_ar === 'ov_up_90') {
              $sql4 = "UPDATE pro_customer_admin_arnya
                            SET ov_up_90 = ((ov_up_90 - '" . floatval($bayar) . "') + '" . floatval($res_invoice['total_bayar']) . "')
                          WHERE id_customer = '" . addslashes($res_invoice['id_customer']) . "'";
            } else {
              $sql4 = null;
            }
      ...
      if (count($res_pembayaran) > 0) {
        foreach ($res_pembayaran as $ri) {
          ...
          $update_cl = "UPDATE pro_customer
                          SET credit_limit_used = credit_limit_used + " . $sisa_tagihan_awal . "
                        WHERE id_customer = '" . addslashes($res_invoice['id_customer']) . "'";
          $con->setQuery($update_cl);
          $oke  = $oke && !$con->hasError();
          ...
          if ($status_ar === 'notyet') {
            $sql4 = "UPDATE pro_customer_admin_arnya
                        SET not_yet = not_yet + " . $sisa_tagihan_awal . "
                      WHERE id_customer = " . intval($res_invoice['id_customer']);
          } elseif ($status_ar === 'ov_up_07') {
            $sql4 = "UPDATE pro_customer_admin_arnya
                        SET ov_up_07 = ov_up_07 + " . $sisa_tagihan_awal . "
                      WHERE id_customer = " . intval($res_invoice['id_customer']);
          } elseif ($status_ar === 'ov_under_30') {
            $sql4 = "UPDATE pro_customer_admin_arnya
                        SET ov_under_30 = ov_under_30 + " . $sisa_tagihan_awal . "
                      WHERE id_customer = " . intval($res_invoice['id_customer']);
          } elseif ($status_ar === 'ov_under_60') {
            $sql4 = "UPDATE pro_customer_admin_arnya
                        SET ov_under_60 = ov_under_60 + " . $sisa_tagihan_awal . "
                      WHERE id_customer = " . intval($res_invoice['id_customer']);
          } elseif ($status_ar === 'ov_under_90') {
            $sql4 = "UPDATE pro_customer_admin_arnya
                        SET ov_under_90 = ov_under_90 + " . $sisa_tagihan_awal . "
                      WHERE id_customer = " . intval($res_invoice['id_customer']);
          } elseif ($status_ar === 'ov_up_90') {
            $sql4 = "UPDATE pro_customer_admin_arnya
                        SET ov_up_90 = ov_up_90 + " . $sisa_tagihan_awal . "
                      WHERE id_customer = " . intval($res_invoice['id_customer']);
          } else {
            $sql4 = null;
          }
