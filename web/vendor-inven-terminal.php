                        ...
                        <div class="box-header with-border">
                            <div class="row">
                            	<div class="col-sm-6">
                                    ...
                                    <?php } ?>
                                    <a href="<?php echo BASE_URL_CLIENT.'/vendor-inven-terminal-list.php'; ?>" class="btn btn-success">
                                        <i class="fa fa-table jarak-kanan"></i> List Pembukuan
                                    </a>
                                </div>
                            	<div class="col-sm-6">
                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="180">JENIS DATA</th>
                                        ...
                                        <th class="text-center" width="130">NILAI</th>
...
$(document).ready(function(){
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/vendor-inven-terminal.php",
