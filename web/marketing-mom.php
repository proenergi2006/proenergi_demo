...
<body class="skin-blue fixed">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <h4 class="text-muted" style="font-style: italic; display: none;">Under Construction</h4>
            <?php $flash->display(); ?>
            <form name="searchForm" id="searchForm" role="form" class="form-horizontal" style="display: none;">
                ...
                <div class="col-sm-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <a href="<?php echo BASE_URL_CLIENT.'/marketing-mom-add.php'; ?>" class="btn btn-primary">
                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-bordered table-hover" id="data-marketing-mom-table">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="10%">No</th>
                                        <th class="text-center" width="20%">Tanggal</th>
                                        <th class="text-center" width="35%">Tempat</th>
...
<style>
	#data-marketing-mom-table td, #data-marketing-mom-table th {font-size:12px;}
</style>
<script>
$(document).ready(function(){
    $("#data-marketing-mom-table").ajaxGrid({
        url  : "./datatable/marketing-mom.php",
        data : {q1 : $("#q1").val(), q2 : $("#q2").val(), q3 : $("#q3").val()},
    });
    $('#btnSearch').on('click', function(){
        var param = {q1 : $("#q1").val(), q2 : $("#q2").val(), q3 : $("#q3").val()};
        $("#data-marketing-mom-table").ajaxGrid("draw", {data : param}); 
        return false;
    });
    $('#tableGridLength').on('change', function(){
        $("#data-marketing-mom-table").ajaxGrid("pageLen", $(this).val());
    });
    $('#data-marketing-mom-table').on('click', '[data-action="deleteGrid"]', function(e){
        e.preventDefault();
        if(confirm("Apakah anda yakin ?")){
            ...
            var handler = function(data){
                if(data.error == ""){
                    $(".alert").slideUp();
                    $("#data-marketing-mom-table").ajaxGrid("draw");
                } else{
                    $(".alert").slideUp();
    ...
    $('#data-marketing-mom-table').on('click', '[data-action="confirmGrid"]', function(e){
        e.preventDefault();
        if(confirm("Apakah anda yakin ?")){
