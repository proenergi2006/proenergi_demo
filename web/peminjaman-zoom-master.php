...
<body class="skin-blue fixed">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <?php if ($sesrole == '1') : ?>
                                            <a href="<?php echo BASE_URL_CLIENT . '/peminjaman-zoom-master-add.php'; ?>" class="btn btn-primary"><i class="fa fa-plus jarak-kanan"></i> Add Data</a>
                                        <?php endif ?>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <table class="table table-bordered" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="">Nama Zoom</th>
    ...
    <script>
        $(document).ready(function() {
            $("#table-grid").ajaxGrid({
                url: "./datatable/peminjaman-zoom-master.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val()
                },
