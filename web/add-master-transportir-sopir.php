<?php
    ...
    if (isset($enk['idr']) && $enk['idr']!== ''){
        $action 	= "update"; 
		$section 	= "Edit Master Sopir Transportir";
        $idr = isset($enk["idr"])?htmlspecialchars($enk["idr"], ENT_QUOTES):'';
        $sql = "select a.*, b.nama_transportir, b.nama_suplier, b.lokasi_suplier from pro_master_transportir_sopir a 
    	...
    	$rsm = null;
		$action 	= "add";
		$section 	= "Tambah Master Sopir Transportir";
		$chk		= "checked";
		$rsm 		= array();
	}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <form action="<?php echo ACTION_CLIENT.'/master-transportir-sopir.php'; ?>" id="gform" name="gform" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label>Nama Sopir *</label>
                                        <input type="text" id="nama_sopir" name="nama_sopir" class="form-control validate[required]" value="<?php echo $rsm['nama_sopir'] ?? null;?>" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
								...
								<?php if(count($row1) > 0){ foreach($row1 as $dat2){ echo '<input type="hidden" name="doksup['.$dat2['id_tsd'].']" value="1" />'; } } ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="pad bg-gray">
                                            ...
                                            <a href="<?php echo BASE_URL_CLIENT."/master-transportir-sopir.php"; ?>" class="btn btn-default jarak-kanan">
