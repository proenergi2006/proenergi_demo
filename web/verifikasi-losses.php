...
<body class="skin-blue fixed">
                                ...
                                <table class="table table-bordered table-hover" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">Kode DR</th>
                                            <th class="text-center" width="10%">Tanggal Penggajuan</th>
                                            <th class="text-center" width="10%">Tanggal DR</th>
                                            <th class="text-center" width="20%">Customer</th>
                                            <th class="text-center" width="10%">Nomor PO</th>
                                            <th class="text-center" width="12%">Nomor DN</th>
                                            <th class="text-center" width="10%">Cabang</th>
                                            <th class="text-center" width="10%">Qty</th>
                                            <th class="text-center" width="10%">Realisasi</th>
                                            <th class="text-center" width="10%">Losses</th>
                                            <th class="text-center" width="17%">Disposisi</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGrid({
                url: "./datatable/verifikasi-losses-data.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val()
