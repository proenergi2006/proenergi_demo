        ...
        <div class="table-responsive-satu">
            <table class="table table-bordered table-grid3" id="table-grid3">
                ...
                <tbody>
                    ...
                    g.top_plan, i.credit_limit, o1.harga_normal, o2.harga_normal as harga_normal_new, h.harga_poc, m.detail_rincian, g.status_plan, g.catatan_reschedule,g.status_jadwal,
                    ...
                    left join pro_master_harga_minyak o1 on m.masa_awal = o1.periode_awal and m.masa_akhir = o1.periode_akhir and m.id_area = o1.id_area 
                        ...
                        left join pro_master_harga_minyak o2 on m.masa_awal = o2.periode_awal and m.masa_akhir = o2.periode_akhir and m.id_area = o2.id_area 
...
<div style="margin-bottom:0px;">
    ...
    <a href="<?php echo BASE_URL_CLIENT . '/verifikasi-request-pr.php'; ?>" class="btn btn-default jarak-kanan" style="min-width:90px;">Kembali</a>
