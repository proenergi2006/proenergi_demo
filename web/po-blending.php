        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <div style="margin:15px 0px;">
                    <?php if ($sesRole == 5) { ?>
                        <a href="<?php echo BASE_URL_CLIENT . '/po-blending-add.php'; ?>" class="btn btn-primary jarak-kanan">
                    ...
                    <table class="table table-bordered table-hovera" id="table-grid">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="150">Nomor PO Blending</th>
                                <th class="text-center" width="100">Tgl Blending</th>
                                <th class="text-center" width="150">Vendor</th>
                                <th class="text-center" width="250">Terminal</th>
                                <th class="text-center" width="150">Volume Total</th>
                                <th class="text-center" width="">Harga</th>
                                <th class="text-center" width="150">Nomor Po Supplier</th>
