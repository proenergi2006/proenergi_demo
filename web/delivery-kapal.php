...
<body class="skin-blue fixed">
					...
					<div class="col-sm-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<div class="row">
									<div class="col-sm-6">
										<a href="<?php echo BASE_URL_CLIENT . '/delivery-kapal-add.php'; ?>" class="btn btn-primary">
								...
								<table class="table table-bordered table-hover" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="15%">Nomor DR</th>
											<th class="text-center" width="10%">Nomor DN</th>
											<th class="text-center" width="13%">Nomor PO</th>
											<th class="text-center" width="10%">Customer</th>
											<th class="text-center" width="5%">Volume</th>
											<th class="text-center" width="7%">Tanggal DN</th>
											<th class="text-center" width="7%">Cabang</th>
											<th class="text-center" width="12%">Terminal</th>
	...
	<script>
		$(document).ready(function() {
			$("#table-grid").ajaxGrid({
				url: "./datatable/delivery-kapal.php",
				data: {
					q1: $("#q1").val()
				},
			});
