...
<body class="skin-blue fixed">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
			...
			<section class="content">
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation" class=""><a href="#data-summary" aria-controls="data-summary" role="tab" data-toggle="tab">Summary Persetujuan</a></li>
					<li role="presentation" class=""><a href="#data-review" aria-controls="data-review" role="tab" data-toggle="tab">Review Customer</a></li>
					<?php } ?>
				</ul>
                            ...
                            <div class="box-body" style="border:1px solid #ddd;">
                                <div class="table-responsive">
                                    <table class="table no-border">
                                        ...
                                        <tr>
                                            <td colspan="2">JENIS CUSTOMER</td>
                                            <td class="text-center">:</td>
                                            <td><?php echo $rsm['jenis_customer'];?></td>
                                        </tr>
                                        <tr>
			...
			<div role="tabpanel" class="tab-pane" id="data-summary">
				 <?php
					if($rsm['ceo_result']=='1' && $rsm['status_customer'] > 1){
						require_once($public_base_directory."/web/__get_data_customer_ceo.php");
					}else if($rsm['ceo_result']!='1' && $rsm['status_customer'] > 1){
						require_once($public_base_directory."/web/__get_data_customer_cfo.php");
					}
				?>
			</div>
        ...
        <div style="margin-bottom:15px;">
			<?php if($rsm['status_customer'] == 1){ ?>
            <a href="<?php echo BASE_URL_CLIENT."/customer-edit.php?".$server_uri;?>" class="btn btn-primary jarak-kanan" style="min-width:90px;">
