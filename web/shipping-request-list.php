	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
        	<section class="content-header">
        		<h1>Shipping Instruction Request</h1>
        	</section>
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <div class="row">
                            	<!-- <div class="col-sm-6">
									<?php if($sesRole == 5){ ?>
                                    <a href="<?php echo BASE_URL_CLIENT.'/vendor-inven-terminal-add.php'; ?>" class="btn btn-primary jarak-kanan">
                                        <i class="fa fa-plus jarak-kanan"></i> Add Data
                                    </a> 
                                    <?php } ?>
                                </div> -->
                            	<div class="col-sm-12">
                                    <div class="text-left" style="margin-top: 10px">Show 
                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="170">NO Ship Req</th>
                                        <th class="text-center" width="140">NO PO Supplier</th>
                                        <th class="text-center" width="150">Tanggal</th>
                                        <th class="text-center" width="130">Quantity</th>
                                        <th class="text-center" width="250">Discharging Terminal</th>
                                        <th class="text-center" width="120">Disposisi</th>
...
$(document).ready(function(){
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/vendor-inven-ship-req.php",
