        ...
        <aside class="right-side">
            ...
            <section class="content">
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="q8" id="q8" class="form-control input-sm validate[required,custom[date]] datepicker" autocomplete='off' />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div style="margin:15px 0px;">
                    <a href="<?php echo BASE_URL_CLIENT . '/vendor-po-new-add.php'; ?>" class="btn btn-primary"><i class="fa fa-plus jarak-kanan"></i> Add Data</a>
                </div>
                    ...
                    <table class="table table-bordered table-hovera" id="table-grid">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="150">Volume (Liter)</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGridNew({
                url: "./datatable/vendor-po-new.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
