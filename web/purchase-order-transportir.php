<?php
	...
	$sesgr	= paramDecrypt($_SESSION['sinori'.SESSIONID]['suplier']);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4 col-md-3 col-sm-top">
                    <select id="q2" name="q2" class="form-control">
                        <option></option>
                        <option value="1">Verifikasi Transportir</option>
                        <option value="2">Konfirmasi Logistik</option>
                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="21%">Kode PO</th>
                                        <th class="text-center" width="20%">Tanggal</th>
                                        <th class="text-center" width="20%">Cabang</th>
...
$(document).ready(function(){
	...
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/purchase-order-transportir.php",
