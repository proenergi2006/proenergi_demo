...
$sesgr    = paramDecrypt($_SESSION['sinori' . SESSIONID]['id_role']);

// Cek peran pengguna
$required_role = '21';
// Misalnya halaman ini hanya untuk superadmin

if (paramDecrypt($_SESSION['sinori' . SESSIONID]['id_role']) !== $required_role) {
...
<body class="skin-blue fixed">
                                ...
                                <table class="table table-bordered table-hover" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="25%">Kode PR</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGrid({
                url: "./datatable/verifikasi-oa.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val()
                },
