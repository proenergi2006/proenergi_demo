...
if (isset($enk['idr']) && $enk['idr'] !== '') {
    $action     = "detail";
    $section     = "Detail Adjustment";
    $idr = isset($enk["idr"]) ? htmlspecialchars($enk["idr"], ENT_QUOTES) : '';
    $sql = "
            SELECT a.*, a.id_jenis, a.tanggal_inven, b.nomor_po
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <?php $flash->display(); ?>
                <form action="<?php echo ACTION_CLIENT . '/vendor-inven-terminal-new.php'; ?>" id="gform" name="gform" method="post" class="form-horizontal" role="form">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" value="Adjustment" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    <input type="text" id="adj_inven" name="adj_inven" value="<?php echo number_format($dt9); ?>" class="form-control hitung" required />
                            ...
                            <div style="padding:15px 0px;">
                                ...
                                <a href="<?php echo BASE_URL_CLIENT . '/adjustment-stock.php'; ?>" class="btn btn-default" style="min-width:90px;"><i class="fa fa-reply jarak-kanan"></i> Kembali</a>
                            </div>
