                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="13%">Kode Dokumen</th>
                                        <th class="text-center" width="22%">Customer</th>
                                        <th class="text-center" width="13%">Cabang Invoice</th>
                                        <th class="text-center" width="18%">Nomor / Tanggal PO</th>
                                        <th class="text-center" width="17%">Volume / Harga</th>
...
$(document).ready(function(){
	...
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/verifikasi-poc.php",
