            ...
            <section class="content">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="data-truck">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 col-sm-top">
                                    <select id="q2" name="q2" class="form-control">
                                        ...
                                        <option value="4">Tanggal Loaded</option>
                                    </select>
                                </div>
                                <div class="col-sm-3 col-sm-top">
                                    <div class="input-group">
                                        <span class="input-group-addon">Periode</span>
                                        <input type="text" name="q3" id="q3" class="form-control input-sm datepicker" autocomplete="off" disabled />
                                    </div>
                                </div>
                                <div class="col-sm-3 col-sm-top">
                                    <div class="input-group">
                                        <span class="input-group-addon">S/D</span>
                                        <input type="text" name="q4" id="q4" class="form-control input-sm datepicker" autocomplete="off" disabled />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <form action="<?php echo ACTION_CLIENT . '/terminal-do.php'; ?>" id="gform" name="gform" method="post" target="_blank" role="form">
                            <div class="row">
                                <div class="col-sm-12">
                                            ...
                                            <table class="table table-bordered" id="data-truck-table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center" width="9%" colspan="2"><input type="checkbox" name="cekAll" id="cekAll" value="1" /></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="pad bg-gray">
                                        <input type="hidden" name="param" id="param1" value="<?php echo paramEncrypt("do_truck#|#cetak"); ?>" />
                                        <!-- <button type="submit" class="btn btn-success jarak-kanan" name="btnSbmt1" id="btnSbmt1" value="1">Cetak DN</button> -->
                                        <div class="btn-group jarak-kanan">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><button type="submit" class="btn btn-success jarak-kanan" name="btnSbmt1" value="1" style="background-color: #f5f5f5;border-color:#f5f5f5;color: #444;width: -moz-available;text-align: left; ">Dengan Inisial</button></li>
                                                <li><button type="submit" class="btn btn-success jarak-kanan" name="btnSbmt1" value="2" style="background-color: #f5f5f5;border-color:#f5f5f5;color: #444;width: -moz-available;text-align: left; ">Tanpa Inisial</button></li>
                                            </ul>
                                        </div>
                                        <button type="submit" class="btn btn-success" name="btnSbmt2" id="btnSbmt2" value="1">Cetak SPJ</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="padding:0px 5px;" width="100">
                                                ...
                                                <input type="text" name="dt1" id="dt1" class="input-sm datepicker form-control" autocomplete="off" disabled />
                                            </td>
                                            <td width="10">&nbsp;</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#data-truck-table").ajaxGrid({
                url: "./datatable/terminal-do-truck.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
            ...
            $("#data-truck-table").on("ifChecked", "#cekAll", function() {
                $(".chkp").iCheck("check");
            ...
            $('#data-truck-table tbody, #data-kapal-table tbody').on('click', '.resetSts', function(e) {
                var param = $(this).data("param");
                var jenis = $(this).data("jenis");
                var infor = $(this).data("info");
                var angku = $(this).parents("table").first().attr("id");
            ...
            $("[data-toggle='tab']").click(function() {
                ...
                var urlnya = (idnya == "#data-truck") ? "./datatable/terminal-do-truck.php" : "./datatable/terminal-do-kapal.php";
            ...
            $("#revert_load_modal").on("click", "#btnLP2", function() {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    success: function(data) {
                        if ($("#jenisLP2").val() == 2) $("#data-kapal-table").ajaxGrid("draw");
                        else $("#data-truck-table").ajaxGrid("draw");
                        if (data.badge > 0) $("#menubadge21").html(data.badge);
                        $("#loading_modal").modal("hide");
                        if (data.error) {
