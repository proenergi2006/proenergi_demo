...
$sql = "select a.*, c.tanggal_kirim, d.produk_poc, e.nama_customer, f.nama_suplier, b.pr_terminal, g.id_area, h.alamat_survey, i.nama_prov, j.nama_kab, k.wilayah_angkut, 
			m.nama_terminal, m.tanki_terminal, m.lokasi_terminal, b.produk, b.pr_vendor, d.nomor_poc, b.no_do_syop, b.nomor_lo_pr 
	...
	foreach ($result as $data) {
		...
		$content .= '
				<tr>
					...
					<td class="text-left">
						<p style="margin-bottom:0px"><b>NO DO Accurate : </b>' . ($data['no_do_syop'] ? $data['no_do_syop'] : 'N/A') . '</b></p>
						<p style="margin-bottom:0px"><b>No.PO : </b>' . ($data['nomor_po'] ? $data['nomor_po'] : 'N/A') . '</p>
