...
// if ($sesrol == 6) {
// 	$sql .= " and (i.id_group = '" . paramDecrypt($_SESSION['sinori' . SESSIONID]['id_group']) . "')";
// }
...
if ($q1 != "")
	$sql .= " and (upper(h.nomor_poc) like '%" . strtoupper($q1) . "%' or upper(b.no_spj) = '" . strtoupper($q1) . "' or upper(k.nomor_plat) = '" . strtoupper($q1) . "' 
					...
					or upper(c.nomor_lo_pr) like '%" . strtoupper($q1) . "%' or upper(r.lokasi_terminal) like '%" . strtoupper($q1) . "%')";
if ($q2 != "" && $q3 != "" && $q4 == "")
...
if ($q6 != "") {
	$sql .= " and i.id_wilayah = '" . $q6 . "'";
}

if ($q7 != "") {
	$sql .= " and r.id_master = '" . $q7 . "'";
}
