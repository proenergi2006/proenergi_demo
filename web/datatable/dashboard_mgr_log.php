...
if ($tipe == "task_pengiriman") {
	...
	join pro_master_wilayah_angkut s on e.id_wil_oa = s.id_master and e.prov_survey = s.id_prov and e.kab_survey = s.id_kab where 1=1 AND a.is_delivered = '0' AND d.tanggal_kirim >= '2024-01-01'";
	...
	where 1=1 AND a.is_delivered = '1' AND d.tanggal_kirim >= '2024-01-01'";
	...
	$sql = "
		select * from (
			...
			where b.is_delivered = 1 and g.tanggal_kirim >= '2024-01-01' " . $wherekeywords1 . " " . $wheretgl1 . "
			UNION ALL
			...
			where a.is_delivered = 1 and g.tanggal_kirim >= '2024-01-01' " . $wherekeywords2 . " " . $wheretgl2 . "
		) a ";
