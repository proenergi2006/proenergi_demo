...
if ($q1) {
    // Jika ada pencarian, gunakan query ini tanpa ORDER BY
    $sql1 .= " limit " . $start . ", " . $length;
} else {
    // Jika tidak ada pencarian, gunakan query ini untuk mengambil 5 data terbaru
    $sql1 .= " ORDER BY  jumlah_sisa DESC LIMIT 5";
}
...
if ($tot_record <= 0) {
    ...
    foreach ($result as $data) {
        ...
        $jumlah_sisa     = $data['credit_limit'] - $reminding;
