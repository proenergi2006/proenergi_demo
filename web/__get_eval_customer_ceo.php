<?php
	...
	$arrEval 	= array(1=>"Ya (Menjadi Customer Tetap)", "Tidak (Menjadi Customer Penawaran)");
	$dt1 		= str_replace("<br />", PHP_EOL, $rsm['ceo_evaluasi1']);
	$dt2 		= str_replace("<br />", PHP_EOL, $rsm['ceo_evaluasi2']);
	$dt3 		= str_replace("<br />", PHP_EOL, $rsm['ceo_evaluasi3']);
	$tmp 		= json_decode($rsm['ceo_summary'], true);
	...
	$smp4 = json_decode($rsm['sm_summary'], true);
	$smp5 = json_decode($rsm['om_summary'], true);
	$smp6 = json_decode($rsm['cfo_summary'], true);
?>
...
<h3 class="form-title bg-light-blue">BRANCH MANAGER</h3>
<div class="bungkus-title">
    <div class="form-group row">
        <div class="col-sm-6">
            <label>Catatan BM</label>
            <div class="form-control" style="height:auto">
                <?php echo str_replace("<br />", PHP_EOL, $smp4['summary']); ?>
                <p style="margin:10px 0 0; font-size:12px;"><i><?php echo $smp4['pic']." - ".$smp4['tanggal']." WIB";?></i></p>
            </div>
        </div>
        <div class="col-sm-6 col-sm-top">
...
<h3 class="form-title bg-light-blue">OPERATION MANAGER</h3>
<div class="bungkus-title">
    <div class="form-group row">
        <div class="col-sm-6">
            <label>Catatan OM</label>
            <div class="form-control" style="height:auto">
                <?php echo str_replace("<br />", PHP_EOL, $smp5['summary']); ?>
                <p style="margin:10px 0 0; font-size:12px;"><i><?php echo $smp5['pic']." - ".$smp5['tanggal']." WIB";?></i></p>
            </div>
        </div>
        <div class="col-sm-6 col-sm-top">
            <label>Persetujuan OM</label>
            <p><?php echo $arrSetuju[$rsm['om_result']]; ?></p>
        </div>
    </div>
</div>

<h3 class="form-title bg-light-blue">CFO</h3>
<div class="bungkus-title">
    <div class="form-group row">
        <div class="col-sm-6">
            <label>Catatan CFO</label>
            <div class="form-control" style="height:auto">
                <?php echo str_replace("<br />", PHP_EOL, $smp6['summary']); ?>
                <p style="margin:10px 0 0; font-size:12px;"><i><?php echo $smp6['pic']." - ".$smp6['tanggal']." WIB";?></i></p>
            </div>
        </div>
        <div class="col-sm-6 col-sm-top">
            <label>Persetujuan CFO</label>
...
<div class="form-group row">
    ...
    <div class="col-sm-6 col-sm-top">
        <label>Persetujuan CEO</label>
        <div class="radio clearfix" style="margin:0px;">
            <label class="col-xs-12" style="margin-bottom:5px;"><input type="radio" name="result" id="result1" value="1" /> Ya (Menjadi Customer Tetap)</label>
            <label class="col-xs-12" style="margin-bottom:5px;"><input type="radio" name="result" id="result2" value="2" /> Tidak (Menjadi Customer Penawaran)</label>
        </div>
    </div>
</div>
<div class="row">
		...
		<div class="col-sm-6 col-sm-top">
			...
			<div class="radio clearfix" style="margin:0px;">
				<label class="col-xs-12" style="margin-bottom:5px;">
					<input type="radio" name="result" id="result" value="1" checked /><?php echo $arrSetuju[$rsm['ceo_result']];?>
				</label>
			</div>
		</div>
	</div>
