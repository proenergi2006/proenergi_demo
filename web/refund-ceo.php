    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <!-- <div class="modal fade" id="detail_refund" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-blue">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">Detail Refund</h4>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $("#data-truck-table").ajaxGrid({
                url: "./datatable/refund-truck-ceo.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val()
            ...
            // $('#data-truck-table tbody, #data-kapal-table tbody').on('click', '.Detail', function(e) {
            //     var param = $(this).data("param");
            //     var split = param.split('|#|');
            //     var total_refund = $(this).data("refund");
            //     $("#detail_refund").find("#no_invoice").html(split[0]);
            //     $("#detail_refund").find("#nama_customer").html(split[1]);
            //     $("#detail_refund").find("#po_customer").html(split[2] + ' | ' + split[3] + ' Liter');
            //     $("#detail_refund").find("#tgl_terbit").html(split[4]);
            //     $("#detail_refund").find("#tgl_terima").html(split[5]);
            //     $("#detail_refund").find("#tgl_bayar").html(split[6]);
            //     $("#detail_refund").find("#total_refund").html('Rp. ' + total_refund);
            //     $("#detail_refund").modal();
            // });
            ...
            $("[data-toggle='tab']").click(function() {
                ...
                var urlnya = (idnya == "#data-truck") ? "./datatable/refund-truck-ceo.php" : "./datatable/refund-kapal.php";
