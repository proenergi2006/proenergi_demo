...
inner join acl_role c on b.id_role = c.id_role  where id_pmnt_order = '".$idr."'";
	...
	$link1 	= BASE_URL_CLIENT.'/permintaan-order.php';
	$link2 	= BASE_URL_CLIENT.'/permintaan-order-add.php?'.paramEncrypt('idr='.$idr);
                    ...
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label><u>Contact Person</u></label>
                                        <p style="margin:0px"><?php echo $rsm['pic_name'];?></p>
										<p style="margin-bottom:0px"><?php echo ucwords(str_replace('ROLE ','',strtoupper($rsm['role_name'])));?></p>
                                        <p style="margin:0px"><?php echo $rsm['pic_telp'];?></p>
                                        <p style="margin:0px"><?php echo $rsm['pic_email'];?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
