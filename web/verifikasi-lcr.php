...
$(document).ready(function(){
	$("select#q2").select2({placeholder: "Persetujuan", allowClear:true});
	$("select#q3").select2({ placeholder: "Provinsi", allowClear: true });
	$("select#q4").select2({ placeholder: "Kabupaten", allowClear: true });
	$("select#q5").select2({ placeholder: "Cabang", allowClear: true });
	...
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/verifikasi-lcr.php",
		data : {q1 : $("#q1").val(), q2 : $("#q2").val(), q3 : $("#q3").val(), q4 : $("#q4").val(), q5 : $("#q5").val(), q6 : $("#q6").val(), q7 : $("#q7").val()}
	});
	$('#btnSearch').on('click', function(){
		var param = {q1 : $("#q1").val(), q2 : $("#q2").val(), q3 : $("#q3").val(), q4 : $("#q4").val(), q5 : $("#q5").val(), q6 : $("#q6").val(), q7 : $("#q7").val()};
