...
if (!$idnya02) {
    ...
    $dt10     = ($rsm['volume_po'] ? number_format($rsm['volume_po'], 0, ',', '.') . ' m³' : '');
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <form action="<?php echo ACTION_CLIENT . '/vendor-po-crushed-stone-new-terima.php'; ?>" id="gform" name="gform" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
            ...
            $("#btnSbmt").click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $("#gform").submit(); // Kirim form setelah konfirmasi
                    }
                });
            });
