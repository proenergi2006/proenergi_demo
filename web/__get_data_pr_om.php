    ...
    <div style="width:2060px; height:auto;">
        <div class="table-responsive-satu">
            <table class="table table-bordered" id="table-grid3">
                <thead>
                    <tr>
                        <th class="text-center" rowspan="2" width="50"></th>
                        ...
                        <!-- <th class="text-center" rowspan="2" width="100">Other Cost</th> -->
                    </tr>
                    <tr>
				...
				<?php 
                    $sql = "select a.*, b.sm_result, b.sm_summary, b.sm_pic, b.sm_tanggal, b.purchasing_result, b.purchasing_summary, b.purchasing_pic, b.purchasing_tanggal, 
							b.cfo_result, b.cfo_summary, b.cfo_pic, b.cfo_tanggal, b.is_ceo, b.ceo_result, b.ceo_summary, b.ceo_pic, b.ceo_tanggal, 
							...
							h.kode_pelanggan, b.revert_ceo, b.revert_ceo_summary 
                ...
                ?>
                    <tr>
						...
						<?php 
							echo '<p style="margin-bottom:0px">'.number_format($data['pr_harga_beli']).'</p>';
						?></td>
                ...
                <tfoot>
                	<tr>
                    	...
                    	<th colspan="3" class="text-center">&nbsp;</th><th colspan="7" class="text-center">&nbsp;</th>
                    	<th class="text-right"><?php echo number_format($total3); ?></th>
                    	<th class="text-right">&nbsp;</th>
                    	<th class="text-right"><?php echo number_format($total4); ?></th>
                    	<th class="text-right">&nbsp;</th>
                        <!-- <th class="text-right"><?php echo number_format($total5); ?></th> -->
...
<?php if (isset($res[0]['sm_summary']) or isset($res[0]['purchasing_summary'])) { ?>
<div class="form-group row">
    <?php if (isset($res[0]['sm_summary'])) { ?>
    <div class="col-sm-6">
    ...
    <?php } ?>
    <?php if (isset($res[0]['purchasing_summary'])) { ?>
...
<?php if (isset($res[0]['ceo_summary'])) { ?>
<div class="form-group row persetujuan-ceo <?php echo (!$fnr)?'hide':'';?>">
    <div class="col-sm-6">
        <label>Catatan CEO</label>
        <div class="form-control" style="height:auto">
            <?php echo ($res[0]['ceo_summary'] ?? null); ?>
            <p style="margin:10px 0 0; font-size:12px;"><i><?php echo (isset($res[0]['ceo_pic']) and isset($res[0]['ceo_tanggal'])) ? $res[0]['ceo_pic']." - ".date("d/m/Y H:i:s", strtotime($res[0]['ceo_tanggal']))." WIB" : ''; ?></i></p>
        </div>
    </div>
</div>
<?php } ?>
