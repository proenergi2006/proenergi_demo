...
if ($act == 'cek') {
	...
	if ($dt1 == "" || $dt3 == "" || $dt5 == "" || $dt6 == "") {
		...
		if ($id1nya) {
			...
			$sql = "
					insert into new_pro_inventory_vendor_po(id_master, id_vendor, id_produk, id_terminal, nomor_po, tanggal_inven, volume_po, harga_tebus, kategori_oa, ongkos_angkut, kategori_plat, iuran_migas, nominal_migas, kd_tax, subtotal, ppn_11,  dpp_11_12, ppn_12, pph_22, nilai_pbbkb, pbbkb, total_order,  terms, terms_day, keterangan,
					created_time, created_ip, created_by, disposisi_po) values ('" . $id1nya . "', '" . $dt5 . "', '" . $dt3 . "', '" . $dt6 . "', '" . $dt2 . "', '" . tgl_db($dt1) . "', '" . $dt10 . "', '" . $dt8 . "', '" . $kategori_oa . "', '" . $ongkos_angkut . "', '" . $kategori_plat . "', '" . $iuran . "', '" . $nominal_iuran . "', '" . $kd_tax . "', '" . $subTotal . "', '" . $ppn_11 . "', '" . $dpp11_12 . "', '" . $ppn_12 . "', '" . $pph_22 . "', '" . $pbbkb_tawar . "', '" . $pbbkb . "', '" . $totalOrder . "', '" . $terms . "', '" . $terms_day . "', '" . $ket . "', NOW(), '" . $_SERVER['REMOTE_ADDR'] . "', '" . paramDecrypt($_SESSION['sinori' . SESSIONID]['fullname']) . "', 1)";
			$con->setQuery($sql);
