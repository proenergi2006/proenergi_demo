...
<p style="font-size:16pt; font-family:times; text-align:center; margin:0 0 5px;"><?php echo 'DAFTAR AKTA WAARMERKING BULAN '.strtoupper(getBulan($bln)).' TAHUN '.$thn; ?></p>
...
<table border="1" cellpadding="0" cellspacing="0" width="100%" class="tabel_data" style="border-collapse:collapse;">
    <tr>
        ...
        <th width="8%">No. Akta</th>
        <th width="10%">Tanggal Akta</th>
        <th width="49%">Sifat Akta</th>
