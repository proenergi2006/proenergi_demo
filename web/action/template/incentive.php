...
if ($tot_record <= 0) {
    ...
    foreach ($result as $data) {
        ...
        // $cek_tier = "SELECT a.id_master, a.nilai_pbbkb, b.harga_normal, b.loco, b.skp, b.harga_sm, b.harga_om, b.harga_coo, b.harga_ceo, b.id_area
        // from pro_master_pbbkb a 
        // left join pro_master_harga_minyak b on a.id_master = b.pajak and b.periode_awal = '" . $data['masa_awal'] . "' and periode_akhir = '" . $data['masa_akhir'] . "' 
        // 	and b.id_area = '" . $data['id_areanya'] . "' and b.produk = '" . $data['produk_poc'] . "' 
        // where a.id_master = 1 
        // order by 1";
        // $row_tier = $con->getRecord($cek_tier);
        ...
        // if ($row_tier['harga_sm'] == 0) {
        // 	$tiernya = "Harga SM masih 0";
        // 	$harganya = "";
        // } elseif ($row_tier['harga_om'] == 0) {
        // 	$tiernya = "Harga OM masih 0";
        // 	$harganya = "";
        // } elseif ($row_tier['harga_coo'] == 0) {
        // 	$tiernya = "Harga COO masih 0";
        // 	$harganya = "";
        // } elseif ($row_tier['harga_ceo'] == 0) {
        // 	$tiernya = "Harga CEO masih 0";
        // 	$harganya = "";
        // } else {
        // 	if ($data['harga_dasarnya'] >= $row_tier['harga_normal']) {
        // 		$tiernya = "Price List";
        // 		$harganya = number_format($row_tier['harga_normal']);
        // 	} elseif ($data['harga_dasarnya'] < $row_tier['harga_normal'] && $data['harga_dasarnya'] >= $row_tier['harga_sm']) {
        // 		$tiernya = "Tier I";
        // 		$harganya = number_format($row_tier['harga_sm']);
        // 	} elseif ($data['harga_dasarnya'] < $row_tier['harga_sm'] && $data['harga_dasarnya'] >= $row_tier['harga_om']) {
        // 		$tiernya = "Tier II";
        // 		$harganya = number_format($row_tier['harga_om']);
        // 	} elseif ($data['harga_dasarnya'] < $row_tier['harga_om'] && $data['harga_dasarnya'] >= $row_tier['harga_coo']) {
        // 		$tiernya = "Tier III";
        // 		$harganya = number_format($row_tier['harga_coo']);
        // 	} else {
        // 		$tiernya = "Tier III Dasar";
        // 		$harganya = number_format($row_tier['harga_coo']);
        // 	}

        // 	// elseif ($data['harga_dasarnya'] < $row_tier['harga_coo'] && $data['harga_dasarnya'] >= $row_tier['harga_ceo']) {
        // 	// 	$tiernya = "Tier IV";
        // 	// 	$harganya = number_format($row_tier['harga_ceo']);
        // 	// } else {
        // 	// 	$tiernya = "Kosong";
        // 	// 	$harganya = "0";
        // 	// }
        ...
        // if ($tiernya == "Price List") {
        // 	$stylenya1 = "background-color:lightgreen;";
        // } else {
        // 	$stylenya1 = "";
        // }
        // if ($tiernya == "Tier I") {
        // 	$stylenya2 = "background-color:lightgreen;";
        // } else {
        // 	$stylenya2 = "";
        // }
        // if ($tiernya == "Tier II") {
        // 	$stylenya3 = "background-color:lightgreen;";
        // } else {
        // 	$stylenya3 = "";
        // }
        // if ($tiernya == "Tier III") {
        // 	$stylenya4 = "background-color:lightgreen;";
        // } else {
        // 	$stylenya4 = "";
        // }
        // if ($tiernya == "Tier IV") {
        // 	$stylenya5 = "background-color:lightgreen;";
        // } else {
        // 	$stylenya5 = "";
        // }
        ...
        if ($data['is_lunas'] == 1) {
            ...
            // 		<tr>
            // 			<td width='48%'>
            // 				" . $rt['keterangan'] . ' | ' . tgl_indo($due_date_week2) . "
            // 			</td>
            // 			<td width='2%'>:</td>
            // 			<td align='right'>
            // 				" . number_format($week2) . "
            ...
            // 		<tr>
            // 			<td width='48%'>
            // 				" . $rt['keterangan'] . ' | ' . tgl_indo($due_date_week3) . "
            // 			</td>
            // 			<td width='2%'>:</td>
            // 			<td align='right'>
            // 				" . number_format($week3) . "
            ...
            // 		<tr>
            // 			<td width='48%'>
            // 				" . $rt['keterangan'] . ' | ' . tgl_indo($due_date_week4) . "
            // 			</td>
            // 			<td width='2%'>:</td>
            // 			<td align='right'>
            // 				" . number_format($week4) . "
            ...
            // 		<tr>
            // 			<td width='48%'>
            // 				" . $rt['keterangan'] . ' | ' . tgl_indo($due_date_week5) . "
            // 			</td>
            // 			<td width='2%'>:</td>
            // 			<td align='right'>
            // 				" . number_format($week5) . "
            ...
            // 		<tr>
            // 			<td width='48%'>
            // 				" . $rt['keterangan'] . ' | ' . tgl_indo($due_date_week6) . "
            // 			</td>
            // 			<td width='2%'>:</td>
            // 			<td align='right'>
            // 				" . $week6 . "
        ...
        if ($point == 0) {
            $status = "<div class='badge badge-error'>POINT 0 TIDAK DAPAT INCENTIVE</div>";
        } else {
            if ($data['statusnya'] == 0) {
