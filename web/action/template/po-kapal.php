    ...
    <table border="0" width="100%">
        <tr>
            ...
            <td width="35% " align="center">
                ...
                <p>
                <div><b><?php echo $row['nomor_po']; ?></b></div>
                </p>
            </td>
                ...
                <table class="table_rincian" width="100%" cellspacing="0" cellpadding="5">
                    ...
                    <tr>
                        <td height="100px" valign="top" align="left">
                            ...
                            <?php echo $row['nama_suplier']; ?> <p>
                                <?php echo $row['alamat_suplier']; ?>
                            </p>
            ...
            <th rowspan="3" width="35%" valign="top">
                <table width="100%" style="border:1 solid #888;" cellspacing="0" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td align="left">:</td>
                        <td align="left">
                            <?php echo tgl_indo($row['tanggal_loading']); ?>
                        </td>
                    </tr>
                </table>
                <br>
...
<table border="1" style="border: 1px solid #888; border-collapse: collapse;" cellpadding="5" cellspacing="0" width="100%">
    <thead>
        <tr>
            ...
            <th align="center" class="b1 b3 b4" width="20%" style="">DN</th>
    ...
    <tbody>
        ...
        $nom++;
        $bl_lo_jumlah = $row['bl_lo_jumlah'];
        $oa_transportir = $row['oa_transportir'];
        $jumlah_po = $bl_lo_jumlah *  $oa_transportir;




        $total1 = $total1 + $bl_lo_jumlah;
        $total2 = $total2 + $oa_transportir;
        $total3 = $total3 + $jumlah_po;

        ?>

        <tr>
            <td valign="top" align="left" style="font-size: 9pt;"> <?php echo $row['nama_terminal']; ?> - <?php echo $row['lokasi_terminal']; ?>
            </td>
            <td valign="top" align="left" style="font-size: 9pt;"> <?php echo $row['nama_customer']; ?> - <?php echo $row['alamat_survey']; ?>
            </td>
            <td height="30px" style="font-size: 9pt;" valign="top" align="left">
                <?php echo $row['nomor_dn_kapal']; ?><p>
                    Captain : <?php echo $row['kapten_name']; ?>
                <p>
                    Vessel Name : <?php echo $row['vessel_name']; ?>
                </p>
                </p>
            </td>
            <td valign="top" align="center" style="font-size: 9pt;">
                <?php echo number_format($bl_lo_jumlah, 0, '', '.'); ?>
            </td>

            <td valign="top" align="center" style="font-size: 9pt;">
                <?php echo number_format($oa_transportir, 0, '', '.'); ?> </td>
        ...
        <th align="right">
            <table width="100%" style="border:1 solid #888;" cellspacing=" 0" cellpadding="5">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><b> <?php echo number_format(($total3 + $diskon), 0, '', '.'); ?></b></td>
                </tr>
