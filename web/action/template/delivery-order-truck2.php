...
<div style="width:100%; margin-bottom:30px; border-top:1px solid; border-bottom:1px solid;">
	...
	<div style="width:50%; float:left;">
    	<div style="padding:10px 0;">
            <div style="text-align:right"><barcode code="<?php echo $bar;?>" type="C39" /></div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabel_rincian" style="margin-bottom:50px;">
	<tr>
    	...
    	<td class="b1 b2 b3" width="40%" style="vertical-align:top;"><?php echo $data['nama_terminal'].' '.$data['tanki_terminal'].', '.$data['lokasi_terminal']; ?></td>
	...
	<tr>
    	...
    	<td class="b2" style="vertical-align:top;"><?php echo (!$data['is_loco'])?$data['sold_to']:$data['nama_customer']; ?></td>
   	</tr>
	<tr>
    	<td class="b3 b4" style="vertical-align:top;">SHIP TO</td>
    	<td class="b3" style="vertical-align:top; text-align:center">:</td>
    	<td class="b2 b3" style="vertical-align:top;"><?php echo (!$data['is_loco'])?$data['nama_customer']."<br>".$alamat:$data['alamat_survey'].' '.$alamat; ?></td>
   	</tr>
</table>

<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabel_rincian">
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabel_rincian" style="margin-bottom:20px;">
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabel_rincian" style="margin-bottom:15px;">
    <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabel_rincian" style="margin-bottom:20px;">
    <tr>
