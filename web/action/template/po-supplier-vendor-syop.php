...
if ($data['kategori_oa'] == 2) {
    ...
    $total_order = $subtotal + $ppn + $pph + $pbbkb + $total_oa;
}
    ...
    <tr>
        ...
        <td valign="top" align="right">
            ...
            <?php if ($data['kategori_oa'] == 2) : ?>
                ...
                ?>
                IDR <?php echo $formatted_ongkos_angkut ?>
            <?php endif ?>
            <?php if ($data['iuran_migas'] == 1) : ?>
                <br>
                <br>
                ...
                function customRound($num)
                {
                    ...
                    if ($num < 0) {
                        return ceil($num - 0.5); // For negative numbers, round up
                    }

                    // For positive numbers
                    $decimalPart = $num - floor($num); // Get the decimal part
                ...
                $iuran_migas = ($harga_dasar * 0.25) / 100;
                echo "IDR " . customRound($iuran_migas);
                ?>
            <?php endif ?>
        </td>
        <td valign="top" align="center">
        ...
        <td valign="top" align="right">
            ...
            <?php if ($data['kategori_oa'] == 2) : ?>
                ...
                if (fmod($oa, 1) == 0) {
                    // Jika tidak ada nilai desimal yang signifikan, tampilkan sebagai angka bulat
                    $formatted_oa = number_format($oa, 0, '.', ',');
                } else {
                    // Jika ada nilai desimal yang signifikan, tampilkan dengan format desimal
                    $formatted_oa = number_format($oa, 2, '.', ',');
                }
                ?>
                IDR <?php echo $formatted_oa ?>
            <?php endif ?>
            ...
            <?php if ($data['iuran_migas'] == 1) : ?>
                ...
                <br>
                <?php
                $total_iuran = $data['nominal_migas'];

                // Menggunakan fmod untuk memeriksa apakah ada nilai desimal yang signifikan
                if (fmod($total_iuran, 1) == 0) {
                    // Jika tidak ada nilai desimal yang signifikan, tampilkan sebagai angka bulat
                    $formatted_total_iuran = number_format($total_iuran, 0, '.', ',');
                } else {
                    // Jika ada nilai desimal yang signifikan, tampilkan dengan format desimal
                    $formatted_total_iuran = number_format($total_iuran, 2, '.', ',');
                }
                ?>
                IDR <?php echo $formatted_total_iuran ?>
            <?php endif ?>
        </td>
    </tr>
</table>
            ...
            <table width="100%" style="border:1 solid #888;" cellspacing=" 0" cellpadding="5">
                <tr>
                    ...
                    <td>
                        ...
                        <b> <?php echo number_format($grand_subtotal, 2, '.', ','); ?></b>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?php $jumdpp = ($grand_subtotal / 12) * 11; ?>
