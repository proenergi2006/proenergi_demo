...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabel_rincian" style="font-size: 12px;">
    ...
    <tr>
        <td class="b3 b4" width="50%" style="text-align:center; height:70px;">
            <?php if (!empty($data['print_product'])): ?>
                <?php echo $data['jenis_produk'] . " (" . $data['merk_dagang'] . ")"; ?> - <?php echo $data['print_product'] . "  )"; ?>
            <?php else: ?>
                <?php echo $data['jenis_produk'] . " (" . $data['merk_dagang'] . ")"; ?>
            <?php endif; ?>
        </td>
