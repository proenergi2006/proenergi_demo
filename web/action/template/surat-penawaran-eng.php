...
<div style="margin-left:0px;">
    <div class="div-table" style="margin-bottom:15px;">
        <div class="div-table-row">
            ...
            <div class="div-table-cell"><?php echo $rsm['nama_cabang'] . ", " . date("d F Y"); ?></div>
        </div>
    </div>

    <div class="div-table" style="margin-bottom:15px;">
        <div class="div-table-row">
            <div class="div-table-cell" style="width:40%">Attention to :</div>
    ...
    <div class="div-table" style="margin-bottom:15px;">
        ...
        <div class="div-table-row">
            <div class="div-table-cell" style="width:70%">
                <div style="padding-left:30px;"><?php echo $rsm['jabatan_up']; ?></div>
            </div>
    ...
    <p class="text-center">Price Quotation of <?php echo $rsm['merk_dagang']; ?></p>
    <p class="text-justify" style="margin-bottom:0px;">Dear sir, </p>

    <p class="text-justify">Within this letter, our company PT Pro Energi is a regulated entity commercial and has fuel permit from ESDM, which engaged in Fuel Oil</p>
    <p class="text-justify">From our experiences, trustworthy product, and resources, believed that we can fulfill the oil needs for your company <?php echo $rsm['nama_customer']; ?>. Based on above, we are pleased to quote as follows:</p>
    ...
    <div style="border: 1px solid #888; border-radius:10px; padding:10px 20px; margin-bottom:10px;">
        <div class="div-table" style="margin-bottom:5px;">
            ...
            <div class="div-table-row">
                ...
                <div class="div-table-cell" style="width:190px;">Price per liter</div>
                <div class="div-table-cell text-center" style="width:40px;">:</div>
                <div class="div-table-cell">
                    <?php
                    if ($rsm['perhitungan'] == 1 &&  !$breakdown) {
                        echo '
                            <p style="margin:0px;"><b>IDR. ' . number_format($rsm['harga_dasar'], 0, '', '.') . ' (Harga terima ' . $rsm['lok_kirim'] . ')</b></p>
                                ...
                                if ($temp['rinci']) {
									...
									<div class="div-table-row">
										...
										<div class="div-table-row">
											...
											<div class="div-table-cell text-right" style="width:26%;">' . ($temp['nilai'] ? $temp['nilai'] . ' %' : '&nbsp;') . '</div>
											<div class="div-table-cell text-right" style="width:12%;">IDR. </div>
                        ...
                        <div class="div-table-row">
                            ...
                            <div class="div-table-cell b1 text-right" style="width:12%;">IDR. </div>
                        ...
                        echo '<div class="div-table-row"><div class="div-table-cell">(Calculation with formula)</div></div>';
                        echo '</div>';
                    }
                    ?>
                </div>
            ...
            <div class="div-table-row">
                ...
                <div class="div-table-cell" style="width:190px;">Payment term</div>
                <div class="div-table-cell text-center" style="width:40px;">:</div>
                <div class="div-table-cell"><b><?php echo $arrPayment[$rsm['jenis_payment']]; ?></b></div>
            </div>
            <div class="div-table-row">
                <div class="div-table-cell" style="width:30px;">5.</div>
                <div class="div-table-cell" style="width:190px;">Order Method</div>
                <div class="div-table-cell text-center" style="width:40px;">:</div>
                <div class="div-table-cell"><?php echo 'Order placed ' . $rsm['method_order'] . ' days prior to delivery date'; ?></div>
            </div>
            <div class="div-table-row">
                <div class="div-table-cell" style="width:30px;">6.</div>
                <div class="div-table-cell" style="width:190px;">Supply</div>
                <div class="div-table-cell text-center" style="width:40px;">:</div>
                <div class="div-table-cell"><?php echo 'Product will be delivered after PO confirmation'; ?></div>
            </div>
            <div class="div-table-row">
                <div class="div-table-cell" style="width:30px;">7.</div>
                <div class="div-table-cell" style="width:190px;">Price due to</div>
                <div class="div-table-cell text-center" style="width:40px;">:</div>
                <div class="div-table-cell"><?php echo date("d F Y", strtotime($rsm['masa_awal'])) . " s/d " . date("d F Y", strtotime($rsm['masa_akhir'])); ?></div>
            </div>
            <div class="div-table-row">
                <div class="div-table-cell" style="width:30px;">8.</div>
                <div class="div-table-cell" style="width:190px;">Tolerance</div>
                <div class="div-table-cell text-center" style="width:40px;">:</div>
                <div class="div-table-cell"><?php echo $rsm['tol_susut']; ?> % from total delivery <?= $rsm['alat_ukur'] != NULL ? "based on " . $rsm['alat_ukur'] . " "  : "" ?></div>
            </div>
        </div>
    </div>

    <p class="text-justify">Hopefully we can get the opportunity and trust from you to do the good business relationship with your company.
        Thank you for your attention and cooperation. </p>

    <div class="div-table" style="margin-bottom:15px;">
        <div class="div-table-row">
            <div class="div-table-cell" style="width:35%;">Best Regards, </div>
            <div class="div-table-cell" style="width:14.7%;">&nbsp;</div>
            <div class="div-table-cell b1 b2 b4" style="width:50%;">
                <div style="padding:0px 10px;">Contact person :</div>
            </div>
        </div>
        <div class="div-table-row">
