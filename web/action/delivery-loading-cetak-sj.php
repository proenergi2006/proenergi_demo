...
$sql = "select a.*, i.nama_customer, e.alamat_survey, e.picustomer,  f.nama_prov, g.nama_kab, o.nama_terminal, o.tanki_terminal, o.lokasi_terminal,o.initial, b.no_spj, k.nomor_plat, c.nomor_lo_pr, c.no_do_syop,
			l.nama_sopir, b.volume_po, b.ongkos_po, j.jenis_produk, j.merk_dagang,  CONCAT_WS(' ', j.jenis_produk, j.merk_dagang) AS produk, n.nama_transportir, n.nama_suplier, p.created_by, q.kode_barcode, q.nama_cabang, i.kode_pelanggan, b.tgl_eta_po, m.id_wilayah, m.tgl_approved, p.id_terminal, h.nomor_poc
...
//$code =  $res['id_dsd'];
//$barcode = 'barcode.proenergi.com/' . paramEncrypt($code);
ob_start();
require_once(realpath("./template/delivery-loading-sj.php"));
