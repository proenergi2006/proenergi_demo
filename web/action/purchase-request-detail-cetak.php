...
$sql = "select a.*, b.sm_result, b.nomor_pr, b.sm_summary, b.sm_pic, b.sm_tanggal, c.tanggal_kirim, e.alamat_survey, e.id_wil_oa, f.nama_prov, g.nama_kab, h.nama_customer, h.id_customer, h.kode_pelanggan, i.fullname, l.nama_area, d.harga_poc, k.refund_tawar,k.other_cost, k.detail_rincian, m.jenis_produk, m.merk_dagang, e.jenis_usaha, d.nomor_poc, d.lampiran_poc, d.lampiran_poc_ori, d.id_poc, n.wilayah_angkut, o.nilai_pbbkb, j.kode_barcode
...
$mpdf = null;
if (PHP_VERSION >= 5.6) {
	$mpdf = new \Mpdf\Mpdf(['format' => 'A4', 'setAutoBottomMargin' => 'pad']);
} else
