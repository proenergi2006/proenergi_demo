...
$cek = "select a.*, b.inisial_segel, b.kode_barcode, c.nama_terminal, c.initial, d.nama_suplier, e.volume, g.nama_customer 
...
ob_start();
require_once(realpath("./template/dn-kapal.php"));
...
$filename = "DN_KAPAL_" . sanitize_filename($idr);
