...
<body class="skin-blue fixed">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1>Master Mobil Transportir</h1>
            </section>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3 col-sm-top">
                            <select id="q4" name="q4" class="form-control select2">
                                <option></option>
                                <?php $con->fill_select("nama_cabang", "concat(inisial_cabang,' - ',nama_cabang)", "pro_master_cabang", "", "where is_active=1", "id_master", false); ?>
                            </select>
                        </div>
                    </div>
                    <p style="font-size:11px; margin-top:-10px;"><i>Keywords berdasarkan nomor plat dan kapasitas tanki</i></p>
                    <div class="form-group row">
                        <div class="col-sm-2 col-sm-top">
                            <select id="q5" name="q5" class="form-control select2">
                                <option></option>
                                <?php $con->fill_select("max_kap", "concat(max_kap,' KL')", "pro_master_transportir_mobil", "", "where is_active=1", "max_kap", false); ?>
                            </select>
                        </div>
                        <div class="col-sm-3 col-sm-top">
                    ...
                    <div class="col-sm-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="<?php echo BASE_URL_CLIENT . '/add-master-transportir-mobil.php'; ?>" class="btn btn-primary">
                                ...
                                <table class="table table-bordered table-hover" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="25%">NOMOR PLAT</th>
                                            <th class="text-center" width="35%">TRANSPORTIR</th>
                                            <th class="text-center" width="10%">MAX KAPSTS</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGrid({
                url: "./datatable/master-transportir-mobil.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
