...
<body class="skin-blue fixed">
								...
								<table width="100%" border="0" cellpadding="5">
									...
									<tr>
										...
										<td id="catatan_ceo_td">
											<input type="text" class="form-control" id="catatan_ceo" name="catatan_ceo" placeholder="Masukan catatan disini">
										</td>
									</tr>
								</table>
								<br>
	...
	<script>
		$(document).ready(function() {
			...
			$("#table-grid").ajaxGrid({
				url: "./datatable/master-penerima-refund-ceo.php",
				data: {},
			});
			...
			$('#table-grid').on('click', '.openDetail', function() {
				...
				var is_ceo = myArray[9];
				var approved_ceo_by = myArray[10];
				var approved_ceo_date = myArray[11];
				var catatan_bm = myArray[12];
				var catatan_ceo = myArray[13];
			...
			$("#btnApprove").click(function() {
				...
				var catatan_ceo = $("#catatan_ceo").val();
				Swal.fire({
