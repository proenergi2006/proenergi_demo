                ...
                <div class="col-sm-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <div class="row">
                            	<div class="col-sm-6">
                                    <a href="<?php echo BASE_URL_CLIENT.'/add-master-group-cabang.php'; ?>" class="btn btn-primary">
                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="70%">NAMA WILAYAH</th>
...
$(document).ready(function(){
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/master-group-cabang.php",
