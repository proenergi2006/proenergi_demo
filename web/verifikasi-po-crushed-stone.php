...
<body class="skin-blue fixed">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1>Verifikasi PO Supplier Crushed Stone</h1>
            </section>
                                ...
                                <table class="table table-bordered table-hover" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="15%">Kode PO</th>
                                            <th class="text-center" width="15%">Tanggal</th>
                                            <th class="text-center" width="20%">Vendor/Terminal</th>
                                            <th class="text-center" width="16%">Produk</th>
                                            <th class="text-center" width="16%">Volume m<sup>3</th>
                                            <th class="text-center" width="16%">Harga Tebus</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGrid({
                url: "./datatable/verifikasi-po-crushed-stone.php",
                data: {
                    q1: $("#q1").val()
