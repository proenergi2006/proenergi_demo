<?php
	...
	$dt1 		= str_replace("<br />", PHP_EOL, $rsm['logistik_evaluasi1']);
	$dt2 		= str_replace("<br />", PHP_EOL, $rsm['logistik_evaluasi2']);
	$dt3 		= str_replace("<br />", PHP_EOL, $rsm['logistik_evaluasi3']);
	$tmp 		= json_decode($rsm['logistik_summary'], true);
...
<?php } else{ ?>
	<div class="form-group row">
		<div class="col-sm-10">
			<label>Bulan ke-1</label>
			<div class="form-control" style="height:auto"><?php echo $rsm['logistik_evaluasi1'];?></div>
		</div>
	</div>
	<div class="form-group row">
		<div class="col-sm-10">
			<label>Bulan ke-2</label>
			<div class="form-control" style="height:auto"><?php echo $rsm['logistik_evaluasi2'];?></div>
		</div>
	</div>
	<div class="form-group row">
		<div class="col-sm-10">
			<label>Bulan ke-3</label>
			<div class="form-control" style="height:auto"><?php echo $rsm['logistik_evaluasi3'];?></div>
		</div>
	</div>
	<div class="form-group row">
		<div class="col-sm-6">
		...
		<div class="col-sm-6 col-sm-top">
			...
			<div class="radio clearfix" style="margin:0px;">
				<label class="col-xs-12" style="margin-bottom:5px;">
					<input type="radio" name="result" id="result" value="1" checked /><?php echo $arrResult[$rsm['logistik_result']];?>
				</label>
			</div>
		</div>
	</div>
