                    ...
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <form action="<?php echo ACTION_CLIENT.'/peminjaman-mobil-master.php'; ?>" id="gform" name="gform" method="post" role="form">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="nama_mobil" name="nama_mobil" class="form-control validate[required]" autocomplete = 'off' value="<?=($row?$row['nama_mobil']:'')?>" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label>Plat Mobil *</label>
                                        <input type="text" id="plat_mobil" name="plat_mobil" class="form-control validate[required]" autocomplete = 'off' value="<?=($row?$row['plat_mobil']:'')?>" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="pad bg-gray">
                                            ...
                                            <a class="btn btn-default jarak-kanan" href="<?php echo BASE_URL_CLIENT."/peminjaman-mobil-master.php";?>">
