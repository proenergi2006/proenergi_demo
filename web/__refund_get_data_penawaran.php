...
$sql_penawaran = "select a.*, b.nama_customer, b.top_payment, b.status_customer, c.fullname, d.nama_cabang, e.jenis_produk, e.merk_dagang, f.id_poc, g.harga_sm, g.harga_om, 
			...
			where a.id_customer = '" . $result['id_customernya'] . "' and a.id_penawaran = '" . $rsm_data['id_penawaran'] . "'";
$rsm = $con->getRecord($sql_penawaran);
// echo json_encode($result['id_customernya']);
                        ...
                        <div class="col-sm-10 col-md-8">
                            <div class="table-responsive">
                                ...
                                <?php if ($rsm['pembulatan'] == 1) { ?>
                                    <p style="margin:0px 0px 15px;"><i>*) Perhitungan menggunakan pembulatan</i></p>
                                <?php } else { ?>
                                    <p style="margin:0px 0px 15px;"><i>*) Perhitungan tidak menggunakan pembulatan</i></p>
                                <?php } ?>
