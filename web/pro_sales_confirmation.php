...
// Cek peran pengguna
$required_role = ['1', '7', '21', '4', '3', '10', '15', '6'];
...
<body class="skin-blue fixed">
			...
			<section class="content">
				...
				<form name="searchForm" id="searchForm" role="form" class="form-horizontal">
					<div class="form-group row">
						<div class="col-sm-4">
							<input type="text" class="form-control input-sm" name="q1" id="q1" placeholder="Keywords Customer Name..." />
						</div>
						<div class="col-sm-4">
					...
					<div class="col-sm-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<div class="row">
									<div class="col-sm-6">
										<!-- <a href="<?php echo BASE_URL_CLIENT . '/po-customer-add.php'; ?>" class="btn btn-primary">
								...
								<table class="table table-bordered" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="20%">Nama Customer</th>
											<th class="text-center" width="15%">Marketing</th>
											<th class="text-center" width="16%">Nomor / Tanggal PO</th>
											<th class="text-center" width="16%">Volume / Harga</th>
											<th class="text-center" width="14%">Disposisi</th>
	...
	<script>
		$(document).ready(function() {
			...
			$("#table-grid").ajaxGrid({
				url: "./datatable/pro_sales_confirmation.php",
				data: {
					q1: $("#q1").val(),
					q2: $("#q2").val()
				},
