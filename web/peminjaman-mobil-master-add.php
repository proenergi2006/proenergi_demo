...
if ($idr != "") {
    ...
    $action     = "update";
    $titleAct   = "Ubah Master Data Mobil Operasional";
} else {
    $row         = array();
    $action     = "add";
    $titleAct   = "Tambah Master Data Mobil Operasional";
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <?php $flash->display(); ?>
                <form action="<?php echo ACTION_CLIENT . '/peminjaman-mobil-master.php'; ?>" id="gform" name="gform" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-sm">
                                        <label class="control-label col-md-4">Nama Mobil *</label>
                                        <div class="col-md-8">
                                            <input type="text" id="nama_mobil" name="nama_mobil" class="form-control" value="<?php echo $row['nama_mobil']; ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-sm">
                                        <label class="control-label col-md-4">Plat Mobil *</label>
                                        <div class="col-md-8">
                                            <input type="text" id="plat_mobil" name="plat_mobil" class="form-control" value="<?php echo $row['plat_mobil']; ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group form-group-sm">
                                        <label class="control-label col-md-3">Foto Mobil</label>
                                        <div class="col-md-9">
                                            <?php
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-md-8">
                                            <input type="checkbox" name="active" id="active" value="1" class="form-control" <?= $row['is_active'] == 1 ? 'checked' : '' ?> /> Active
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom:0px;">
                                ...
                                <a href="<?php echo BASE_URL_CLIENT . '/peminjaman-mobil-master.php'; ?>" class="btn btn-default" style="min-width:90px;">
