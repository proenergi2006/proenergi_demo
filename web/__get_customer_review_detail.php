...
<div class="form-horizontal" style="margin:0px 50px;">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <p><b style="font-size:14px;">Status Form Review</b></p>
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group form-group-sm">
                        <div class="col-md-12">
                            <div class="form-control" style="height:auto; min-height:68px; font-size:14px; background-color:#f5f5f5;">
                                <?php echo $disposisi;?>
                            </div>
                        </div>
                    </div>
    ...
    <div style="margin-bottom:0px;">
		<?php 
			...
			$link3 		= ACTION_CLIENT."/customer-review-resubmit.php?".paramEncrypt("idr=".$idr."&idk=".$idk."&flag=persetujuan");
			$link4 		= ACTION_CLIENT."/credit-app-form-cetak.php?".paramEncrypt("idr=".$idr."&idk=".$idk);
			$link_email = BASE_URL_CLIENT."/send-email-customer.php?".paramEncrypt("idv=".$idr."&idk=".$rsm['id_customer']."&idr=".$idk);
			$linkCetak 	= ACTION_CLIENT."/customer-review-cetak.php?".paramEncrypt("idr=".$idr."&idk=".$idk);

			echo '
			<a class="btn btn-default jarak-kanan" style="min-width:90px;" href="'.$link1.'">
			<i class="fa fa-reply jarak-kanan"></i> Kembali</a> ';

			if(!$rsm['disposisi_result']){
				echo '
				<a class="btn btn-primary jarak-kanan" style="min-width:90px;" href="'.$link2.'">
				<i class="fa fa-edit jarak-kanan"></i> Edit Data</a> ';

				echo '
				<button type="button" class="btn btn-success izin-pd jarak-kanan" style="min-width:90px;" data-href="'.$link3.'">
				<i class="fa fa-list jarak-kanan"></i> Persetujuan</button> ';
			}

			echo '
			<a class="btn btn-info jarak-kanan" target="_blank" style="min-width:90px;" href="'.$linkCetak.'">
			...
			<a class="btn btn-info" href="<?php echo $link4;?>" title="Cektak Credit Application Form"><i class="fa fa-print jarak-kanan"></i>Credit App. Form</a>
			*/
        ?>    
    </div>
</div>
