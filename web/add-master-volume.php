<?php
    ...
    if (isset($enk['idr']) && $enk['idr']!== ''){
        ...
        $sql = "select * from pro_master_volume where id_master = '".$idr."';";
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
        	<section class="content-header">
        		<h1><?php echo $section." Master Volume"; ?></h1>
        	</section>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <form action="<?php echo ACTION_CLIENT.'/master-volume.php'; ?>" id="gform" name="gform" method="post" class="form-validasi" role="form">
                                <div class="form-group clearfix">
                                    <div class="col-sm-6">
                                        <label>Jenis Volume *</label>
                                        <input type="text" id="volume" name="volume" class="form-control validate[required]" value="<?php echo $rsm['volume'];?>" />
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <div class="col-sm-6">
