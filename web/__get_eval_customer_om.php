<?php
	...
	$dt1 		= str_replace("<br />", PHP_EOL, $rsm['om_evaluasi1']);
	$dt2 		= str_replace("<br />", PHP_EOL, $rsm['om_evaluasi2']);
	$dt3 		= str_replace("<br />", PHP_EOL, $rsm['om_evaluasi3']);
	$tmp 		= json_decode($rsm['om_summary'], true);
		...
		<div class="col-sm-6 col-sm-top">
			...
			<div class="radio clearfix" style="margin:0px;">
				<label class="col-xs-12" style="margin-bottom:5px;">
					<input type="radio" name="result" id="result" value="1" checked /><?php echo $arrSetuju[$rsm['om_result']];?>
				</label>
			</div>
		</div>
	</div>
