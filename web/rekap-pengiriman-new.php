                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 col-sm-top">
                            <select id="q2" name="q2" class="form-control">
                                <option></option>
                                <option value="1">Tanggal Kirim</option>
                                ...
                                <table class="table table-bordered" id="data-rekap-pengiriman-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="5%">Area</th>
                                            <th class="text-center" width="13%">Source</th>
                                            <th class="text-center" width="8%">SJ</th>
                                            <th class="text-center" width="6%">Truck No</th>
                                            <th class="text-center" width="6%">Driver</th>
                                            <th class="text-center" width="4%">Transporter</th>
                                            <th class="text-center" width="4%">Transport</th>
                                            <th class="text-center" width="15%">Customer</th>
                                            <th class="text-center" width="7%">City/District</th>
                                            <th class="text-center" width="4%">Qty Delivery (L)</th>
                                            <th class="text-center" width="6%">At Terminal</th>
                                            <th class="text-center" width="6%">At Customer</th>
                                            <th class="text-center" width="6%">Delivery Time</th>
                                            <th class="text-center" width="6%">Qty Received</th>
                                            <th class="text-center" width="6%">Losses</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#data-rekap-pengiriman-table").ajaxGrid({
                url: "./datatable/rekap-pengiriman-new.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
            ...
            $('#btnExport').on('click', function() {
                let url = '<?php echo BASE_URL_CLIENT ?>/report/e-rekap-pengiriman-new-xls.php?name=rekap-pengiriman&' + $('#searchForm').serialize();
