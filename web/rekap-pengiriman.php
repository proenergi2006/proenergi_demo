                                ...
                                <table class="table table-bordered" id="data-rekap-pengiriman-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">Nama Customer</th>
                                            <th class="text-center" width="10%">Alamat</th>
                                            <th class="text-center" width="10%">Plat Nomor</th>
                                            <th class="text-center" width="10%">Driver</th>
                                            <th class="text-center" width="10%">Jumlah/Liter</th>
                                            <th class="text-center" width="10%">MKT</th>
                                            <th class="text-center" width="10%">No. PO</th>
                                            <th class="text-center" width="10%">Product</th>
                                            <th class="text-center" width="10%">No. SPJ</th>
                                            <th class="text-center" width="10%">No. Segel</th>
                                            <th class="text-center" width="10%">No. DO Admin</th>
                                            <th class="text-center" width="10%">Hauler</th>
                                            <th class="text-center" width="10%">Nomor DN</th>
                                            <th class="text-center" width="10%">Kendala</th>
                                            <th class="text-center" width="10%">Dispatcher</th>
                                            <th class="text-center" width="10%">Status</th>
                                            <th class="text-center" width="10%">No. Trip</th>
                                            <th class="text-center" width="10%">No. Order</th>
                                            <th class="text-center" width="10%">Logistik</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#data-rekap-pengiriman-table").ajaxGrid({
                url: "./datatable/rekap-pengiriman.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
            ...
            $('#btnExport').on('click', function() {
                let url = '<?php echo BASE_URL_CLIENT ?>/report/e-rekap-pengiriman-xls.php?name=rekap-pengiriman&' + $('#searchForm').serialize();
