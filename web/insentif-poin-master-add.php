                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="range_awal" name="range_awal" class="form-control validate[required]" autocomplete = 'off' />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label>Range Akhir @hari*</label>
                                        <input type="text" id="range_akhir" name="range_akhir" class="form-control validate[required]" autocomplete = 'off' />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label>Poin*</label>
                                        <input type="text" id="poin" name="poin" class="form-control validate[required]" autocomplete = 'off' />
                                    </div>
                                </div>
