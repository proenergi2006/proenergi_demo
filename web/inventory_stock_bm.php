...
include_once($public_base_directory . "/web/__get_inventory_stock_bm.php");
				...
				<div class="box-header with-border">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							...
							?>
							<p style="font-size:12px;"><i>(* Silahkan Pilih Periode Dahulu)</i></p>
...
<?php include_once($public_base_directory . "/web/__sc_inventory_stock_bm.php"); ?>