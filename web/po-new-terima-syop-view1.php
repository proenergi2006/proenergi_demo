...
$sql = "select a.*, a1.id_po_supplier, a1.volume_bol, f.volume, f.ket, b.jenis_produk, b.merk_dagang, d.nama_vendor, e.nama_terminal, e.tanki_terminal, e.lokasi_terminal 
...
left join new_pro_inventory_gain_loss f on a.id_master = f.id_po_supplier 
...
ob_start();
require_once(realpath("./action/template/po-supplier-vendor-syop1.php"));
