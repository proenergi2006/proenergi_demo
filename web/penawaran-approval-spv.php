                            ...
                            <table class="table table-bordered" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="130">Cabang Invoice</th>
                                        <th class="text-center" width="130">Area</th>
                                        <th class="text-center" width="130">Volume</th>
...
<script>
	$(document).ready(function(){
		...
		$("#table-grid").ajaxGrid({
			url	 : "./datatable/penawaran-approval-spv.php",
