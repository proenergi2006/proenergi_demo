...
<body class="skin-blue fixed">
            ...
            <section class="content">
                ...
                <form name="searchForm" id="searchForm" role="form" class="form-horizontal">
                    <div class="form-group row">
                        <div class="col-sm-3">
                            <input type="text" class="form-control input-sm" name="q1" id="q1" placeholder="Asal" />
                        </div>
                        <div class="col-sm-3 col-sm-top">
                            <input type="text" class="form-control input-sm" name="q2" id="q2" placeholder="Tujuan" />
                        </div>
                        <div class="col-sm-3 col-sm-top">
                    ...
                    <div class="col-sm-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="<?php echo BASE_URL_CLIENT . '/add-master-oa-kapal.php'; ?>" class="btn btn-primary">
                                ...
                                <table class="table table-bordered table-hover" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="20%">Transportir</th>
                                            <th class="text-center" width="11%">Volume Max. (Liter)</th>
                                            <th class="text-center" width="14%">Asal</th>
                                            <th class="text-center" width="14%">Tujuan</th>
                                            <th class="text-center" width="11%">Volume Angkut (Liter)</th>
                                            <th class="text-center" width="7%">Harga/Liter</th>
                                            <th class="text-center" width="11%">Total Harga</th>
    ...
    <script>
        $(document).ready(function() {
            $("#table-grid").ajaxGrid({
                url: "./datatable/master-oa-kapal.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val()
