                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <form action="<?php echo ACTION_CLIENT.'/master-produk.php'; ?>" id="gform" name="gform" method="post" class="form-validasi" role="form">
                                <div class="form-group row">
                                    <div class="col-sm-4 col-md-3">
                                        <label>Jenis Produk *</label>
                                        <input type="text" id="jenis" name="jenis" class="form-control validate[required]" value="<?php echo $rsm['jenis_produk'];?>" />
                                    </div>
                                    <div class="col-sm-4 col-md-3 col-sm-top">
                                        <label>Merk Dagang *</label>
                                        <input type="text" id="merk" name="merk" class="form-control validate[required]" value="<?php echo $rsm['merk_dagang'];?>" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-8 col-md-6">
                                        <label>Catatan</label>
                                        <textarea id="note" name="note" class="form-control"><?php echo str_replace('<br />', PHP_EOL, $rsm['catatan_produk']);?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
