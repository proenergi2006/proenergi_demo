<?php
	...
	$dt1 		= str_replace("<br />", PHP_EOL, $rsm['cfo_evaluasi1']);
	$dt2 		= str_replace("<br />", PHP_EOL, $rsm['cfo_evaluasi2']);
	$dt3 		= str_replace("<br />", PHP_EOL, $rsm['cfo_evaluasi3']);
	$tmp 		= json_decode($rsm['cfo_summary'], true);
...
<div class="form-group row">
    ...
    <div class="col-sm-6 col-sm-top">
        <label>Diterukan ke CEO ?</label>
        <div class="radio clearfix" style="margin:0px;">
            <label class="col-xs-12" style="margin-bottom:5px;"><input type="radio" name="extend" id="extend1" value="1" /> Ya</label>
            <label class="col-xs-12" style="margin-bottom:5px;"><input type="radio" name="extend" id="extend2" value="2" /> Tidak</label>
        </div>
    </div>
</div>
<div class="row">
		...
		<div class="col-sm-6 col-sm-top">
			...
			<div class="radio clearfix" style="margin:0px;">
				<label class="col-xs-12" style="margin-bottom:5px;">
					<input type="radio" name="result" id="result" value="1" checked /><?php echo $arrSetuju[$rsm['cfo_result']];?>
				</label>
			</div>
		</div>
	</div>
