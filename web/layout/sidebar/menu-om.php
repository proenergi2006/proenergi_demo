<li class="<?php echo (in_array($menuKey, $menuOrang)) ? 'treeview active' : 'treeview'; ?>">
    ...
    $sqlBadge17 .= " and d.id_role = 11 and b.disposisi_result = 3 and b.om_result = 0 
                             and c.id_group_cabang = '" . paramDecrypt($_SESSION['sinori' . SESSIONID]['id_group']) . "'";
...
<li class="<?php echo (in_array($menuKey, $mnVer)) ? 'treeview active' : 'treeview'; ?>">
    ...
    $sqlBadge2  = "select count(b.id_verification) as jum from pro_customer a 
                        ...
                        where 1=1";
    $sqlBadge2 .= " and b.disposisi_result = 3 and b.om_result = 0 and 
                            ((c.id_role = 11 and a.id_group = '" . $varGroup . "') or (c.id_role = 17 and c.id_om = '" . $varUser . "'))";
    ...
    $sqlBadge1  = "
			...
			where 1=1  
				and (a.flag_disposisi = 4) and a.flag_approval = 0 and a.om_result = 0
				and ((d.id_role in (11,18,17)) or (d.id_role = 17))
		";
    $jumBadge1  = $con->getOne($sqlBadge1);
    $jumBadgeRole3 += $jumBadge1;

    // $sqlBadge7  = "select count(a.id_cu) as jum from pro_customer_update a join pro_customer b on a.id_customer = b.id_customer where 1=1";
    ...
    // $sqlSales   = "select count(a.id) as jum from pro_sales_confirmation a join pro_po_customer aa on aa.id_poc = a.id_poc left join pro_sales_confirmation_approval s on s.id_sales = a.id where 1=1"; // old
    $sqlSales   = "select count(a.id) as jum from pro_sales_confirmation a join pro_po_customer aa on aa.id_poc = a.id_poc left join pro_sales_confirmation_approval s on s.id_sales = a.id where 1=1 and (a.disposisi = 3 and a.flag_approval = 0)";
    // if(paramDecrypt($_SESSION['sinori'.SESSIONID]['id_role']) == 7)
    ...
    where a.disposisi_losses = 2 and a.om_result = 0 
        
    ";
    $jumBadge11  = $con->getOne($sqlBadge11);
    $jumBadgeRole14 += $jumBadge11;

    $totalBadge = $jumBadgeRole3 + $jumBadgeRole14;
    ?>
    <a>
    ...
    <ul class="treeview-menu">
        ...
        <li class="<?php echo (in_array($menuKey, $menuVerLos)) ? 'active' : ''; ?>">
            <a href="<?php echo BASE_URL_CLIENT . "/verifikasi-losses.php"; ?>"><i class="fa"></i> <span>Verifikasi Losses</span>
                <span id="menubadge19" class="label label-primary pull-right"><?php echo ($jumBadge11 > 0) ? $jumBadge11 : ''; ?></span></a>
        </li>
        <li class="">
...
<li class="<?php echo (in_array($menuKey, $mnReport)) ? 'treeview active' : 'treeview'; ?>">
    ...
    <ul class="treeview-menu">
        ...
        <li class="<?php echo (in_array($menuKey, $mnL5)) ? 'active' : ''; ?>">
            <a href="<?php echo BASE_URL_CLIENT . "/report/l-loading-order.php"; ?>"><i class="fa"></i> <span>Loading Time</span></a>
        </li>
        <li class="<?php echo (in_array($menuKey, $mnC9)) ? 'active' : ''; ?>">
...
<li class="<?php echo (in_array($menuKey, $mnRef)) ? 'treeview active' : 'treeview'; ?>">
    ...
    <ul class="treeview-menu">
        <li class="<?php echo (in_array($menuKey, $mnRef7)) ? 'active' : ''; ?>">
            <a href="<?php echo BASE_URL_CLIENT . "/master-harga-minyak.php"; ?>"><i class="fa"></i> <span>Daftar Harga Dasar</span></a>
        </li>
        ...
        <li class="">
            <a href="#"><i class="fa"></i> <span>Add Transportir</span></a>
        </li>
    </ul>
</li>
