		...
		<aside class="right-side">
			...
			<section class="content">
				...
				<div style="margin:15px 0px;">
					<?php if ($sesRole == 5) { ?>
						<a href="<?php echo BASE_URL_CLIENT . '/vendor-inven-terminal-new-add.php'; ?>" class="btn btn-primary jarak-kanan">
							<i class="fa fa-plus jarak-kanan"></i> Add Data
						</a>
					<?php } ?>
					<a href="<?php echo BASE_URL_CLIENT . '/vendor-inven-terminal-new-list.php'; ?>" class="btn btn-success">
					...
					<table class="table table-bordered table-hovera" id="table-grid">
						<thead>
							<tr>
								...
								<th class="text-center" width="150">Jenis Data</th>
	...
	<script>
		$(document).ready(function() {
			$("#table-grid").ajaxGridNew({
				url: "./datatable/vendor-inven-terminal-new.php",
				data: {
					q1: $("#q1").val()
				},
				infoPage: true,
