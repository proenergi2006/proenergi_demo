	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<script>
				...
				if (in_array(paramDecrypt($_SESSION['sinori' . SESSIONID]['id_role']), array(10))) {
					...
					//new dashboard
					require_once($public_base_directory . "/web/inventory_stock_filter.php");
				}
				...
				if (in_array(paramDecrypt($_SESSION['sinori' . SESSIONID]['id_role']), array(3, 6))) {
					...
					//new dashaboard
					require_once($public_base_directory . "/web/fields_filter.php");
					require_once($public_base_directory . "/web/graph_sales_filter.php");
					require_once($public_base_directory . "/web/graph_customer_filter.php");
					require_once($public_base_directory . "/web/top_5_filter.php");
					require_once($public_base_directory . "/web/graph_unit_filter.php");
					require_once($public_base_directory . "/web/inventory_stock_filter.php");
				}
