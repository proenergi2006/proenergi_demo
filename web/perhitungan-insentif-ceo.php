<?php
    ...
    $insentif = array();
    $sql = "
    select group_concat(a.id) as id_insentif, b.fullname, a.id_marketing, min(a.approve_ceo) as approve_ceo 
    from pro_insentif a
    join acl_user b on b.id_user = a.id_marketing
    where 
    periode like '".$periode."%' 
    and a.approve_hrd = 1
    ...
    foreach ($customer as $i => $val) {
        if ($val['approve_ceo']==0) $is_send = true;
        $insentif[$i]['approve_ceo'] = $val['approve_ceo'];
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="pad bg-gray">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" name="submit" value="ceo"><i class="fa fa-send jarak-kanan"></i>Approve</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php } ?>
