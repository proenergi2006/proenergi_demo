...
if ($q1 == '1' || $q1 == '2') {
	$sqlutama05 = "
		with tbl_cek_data_01 as (
			...
			select a.id_jenis, 'Adjustment' as jenis_penambahan, 
			a.id_produk, a.id_terminal, a.tanggal_inven, 
			a.adj_inven as inputnya 
			...
			where id_jenis in (3, 4) and a.id_produk = '" . $idproduk . "' and a.adj_inven < 0  
