    ...
    <script>
        $(document).ready(function() {
            ...
            $("#data-rekap-pengiriman-table").ajaxGrid({
                url: "./datatable/rekap-pengiriman-marketing.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
            ...
            $('#btnExport').on('click', function() {
                let url = '<?php echo BASE_URL_CLIENT ?>/report/e-rekap-pengiriman-marketing-xls.php?name=rekap-pengiriman&' + $('#searchForm').serialize();
