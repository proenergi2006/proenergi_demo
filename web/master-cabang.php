            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3 col-sm-top">
                    <select id="q3" name="q3" class="form-control select2">
                        <option></option>
                        <?php $con->fill_select("id_gu","group_wilayah","pro_master_group_cabang",$q3,"where is_active=1","id_gu",false); ?>
                    </select>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <div class="row">
                            	<div class="col-sm-6">
                                    <a href="<?php echo BASE_URL_CLIENT.'/add-master-cabang.php'; ?>" class="btn btn-primary">
                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="">NAMA CABANG</th>
                                        <th class="text-center" width="100">INISIAL</th>
                                        <th class="text-center" width="180">WILAYAH</th>
                                        <th class="text-center" width="100">KODE BARCODE</th>
                                        <th class="text-center" width="100">STOK SEGEL</th>
...
$(document).ready(function(){
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/master-cabang.php",
