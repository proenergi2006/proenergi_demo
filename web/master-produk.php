...
<body class="skin-blue fixed">
            ...
            <section class="content">
                ...
                <form name="searchForm" id="searchForm" role="form" class="form-horizontal">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3 col-md-2 col-sm-top">
                    ...
                    <div class="col-sm-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="<?php echo BASE_URL_CLIENT . '/add-master-produk.php'; ?>" class="btn btn-primary">
                                ...
                                <table class="table table-bordered table-hover" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="33%">JENIS</th>
                                            <th class="text-center" width="35%">MERK DAGANG</th>
    ...
    <script>
        $(document).ready(function() {
            $("#table-grid").ajaxGrid({
                url: "./datatable/master-produk.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val()
                },
