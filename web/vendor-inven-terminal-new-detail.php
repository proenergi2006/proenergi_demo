...
if (isset($enk['idr']) && $enk['idr'] !== '') {
    ...
    $sql = "
            SELECT a.*, a.id_jenis, a.tanggal_inven, b.nomor_po ,b.tanggal_inven as tanggal_po, c.tgl_terima, c.volume_terima
            FROM new_pro_inventory_depot a
            JOIN new_pro_inventory_vendor_po b ON a.id_po_supplier = b.id_master
            join new_pro_inventory_vendor_po_receive c ON b.id_master = c.id_po_supplier
            WHERE a.id_master = '" . $idr . "'
		";
    $rsm     = $con->getRecord($sql);
    $idm      = $rsm['id_master'];
    $tglinven     = date("d/m/Y", strtotime($rsm['tanggal_inven']));
    $tglpo     = date("d/m/Y", strtotime($rsm['tanggal_po']));
    $tglterima     = date("d/m/Y", strtotime($rsm['tgl_terima']));
    $tfstock        = ($rsm['adj_inven']) ? $rsm['adj_inven'] : '';
    $volumeterima   = ($rsm['volume_terima']) ? $rsm['volume_terima'] : '';
    $outinven   = ($rsm['out_inven']) ? $rsm['out_inven'] : '';
    $dt8     = ($rsm['nomor_po']) ? $rsm['nomor_po'] : '';
    $ket     =  ($rsm['keterangan']) ? $rsm['keterangan'] : '';
    $ceo    =  ($rsm['ceo_summary']) ? $rsm['ceo_summary'] : '';

    $dt9   = ($rsm['adj_inven']) ? $rsm['adj_inven'] : '';
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <?php $flash->display(); ?>
                <?php if ($rsm['id_jenis'] == 2) { ?>
                    <form id="gform" name="gform" method="post" class="form-horizontal" role="form">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="tgl" name="tgl" class="form-control <?php echo $class1; ?>" required data-rule-dateNL="1" value="<?php echo $tglinven; ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <select id="id_terminal" name="id_terminal" class="form-control select2" style="width:100%;" required>
                                                        <option></option>
                                                        <?php $con->fill_select("id_master", "concat(nama_terminal,' - ',tanki_terminal)", "pro_master_terminal", $rsm['id_terminal'], "where is_active=1", false); ?>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <input type="text" value="<?php echo $dt8; ?>" class="form-control" required />
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <input type="text" value="<?php echo $tglpo; ?>" class="form-control" required />
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <input type="text" value="<?php echo $tglterima; ?>" class="form-control" required />
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        <input type="text" id="adj_inven" name="adj_inven" value="<?php echo ($volumeterima); ?>" class="form-control hitung" required />
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        <input type="text" id="adj_inven" name="adj_inven" value="<?php echo ($outinven); ?>" class="form-control hitung" required />
                                                        <span class="input-group-addon">Liter</span>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea id="keterangan" name="keterangan" class="form-control" style="min-height:100px;"><?php echo $ket; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="padding:15px 0px;">
                                    ...
                                    <a href="<?php echo BASE_URL_CLIENT . '/vendor-inven-terminal-new.php'; ?>" class="btn btn-default" style="min-width:90px;"><i class="fa fa-reply jarak-kanan"></i> Kembali</a>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group form-group-sm">
                                            <label class="control-label col-md-3">Jenis Penambahan *</label>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" value="Transfer Stock" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" width="">Nomor PO </th>
                                                <th class="text-center" width="">Tgl PO </th>
                                                <th class="text-center" width="150">Tgl Transfer</th>
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "select
                                                    ...
                                                    FROM 
                                                        new_pro_inventory_depot a
                                                    JOIN 
                                                        pro_master_terminal b ON a.id_terminal = b.id_master
                                                    JOIN 
                                                        new_pro_inventory_vendor_po c ON a.id_po_supplier = c.id_master
                                                    WHERE 
                                                        a.id_jenis = 4 AND
                                                        (
                                                            (a.id_master != '" . $idm . "' AND 
                                                            a.id_jenis = (SELECT id_jenis FROM new_pro_inventory_depot WHERE id_master = '" . $idm . "') AND
                                                            a.id_terminal = (SELECT id_terminal FROM new_pro_inventory_depot WHERE id_master = '" . $idm . "') AND
                                                            a.tanggal_inven = (SELECT tanggal_inven FROM new_pro_inventory_depot WHERE id_master = '" . $idm . "') AND
                                                            a.created_time = (SELECT created_time FROM new_pro_inventory_depot WHERE id_master = '" . $idm . "')
                                                            ) 
                                                            OR 
                                                            (a.id_master = '" . $idm . "')
                                                        );
";
                                            ...
                                            // Proses hasil query
                                            $res = $con->getResult($sql); // Asumsi koneksi ke DB dengan $con
                                            $grandTotal = 0;
                                            ...
                                            if (count($res) == 0) {
                                                ...
                                                foreach ($res as $data) {
                                                    $nom++;
                                                    $volume = $data['adj_inven']; // Menggunakan abs untuk menghapus minus
                                                    $grandTotal += $volume; // Menambahkan volume ke grand total
                                            ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $nom; ?></td>
                                                        <td class="text-center"><?php echo $data['nomor_po']; ?></td>
                                                        <td class="text-center"> <?php echo date('d-m-Y', strtotime($data['tgl_po'])); ?></td>
                                                        <td class="text-center"> <?php echo date('d-m-Y', strtotime($data['tanggal_inven'])); ?></td>
                                                        <td class="text-center"><?php echo number_format($volume); ?> Liter</td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-center"><strong><?php echo number_format($grandTotal); ?> Liter</strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
