                ...
                <div style="border: 1px solid #888; border-radius:10px; padding:10px 20px; margin-bottom:10px;">
                    <div class="div-table" style="margin-bottom:5px;">
                        ...
                        <div class="div-table-row">
                            ...
                            <div class="div-table-cell">
                                ...
                                if ($rsm['perhitungan'] == 1 && !$breakdown) {
                                    ...
                                    echo '
                                    <p style="margin:0px;"><b>IDR. ' . $harga_dasar . ' (Harga terima ' . $rsm['lok_kirim'] . ')</b></p>
                                ...
                                <div class="div-table-row">
                                    ...
                                    echo '
                                <div class="">
                                    <div class="" style="width:26%;"> IDR. <b>' . $harga_dasar . '</b></div>
                                </div>';
                                    echo '</div>';
                                    echo '<p style="margin:3px 0px;">' . ($rsm['ket_harga'] ? $rsm['ket_harga'] : '') . '</p>';
                        ...
                        <div class="div-table-row">
                            ...
                            <div class="div-table-cell text-center" style="width:40px;">:</div>
                            <div class="div-table-cell" style=""><?php echo 'Order placed ' . $rsm['method_order'] . ' days prior to delivery date'; ?></div>
                        </div>
                        <div class="div-table-row">
                            <div class="div-table-cell" style="width:30px;">6.</div>
                            <div class="div-table-cell" style="width:190px;">Supply</div>
                            <div class="div-table-cell text-center" style="width:40px;">:</div>
                            <div class="div-table-cell" style=""><?php echo 'Product will be delivered after PO confirmation'; ?></div>
                        </div>
                        <div class="div-table-row">
                            <div class="div-table-cell" style="width:30px;">7.</div>
                            <div class="div-table-cell" style="width:190px;">Price due to</div>
                            <div class="div-table-cell text-center" style="width:40px;">:</div>
                            <div class="div-table-cell" style=""><?php echo date("d F Y", strtotime($rsm['masa_awal'])) . " s/d " . date("d F Y", strtotime($rsm['masa_akhir'])); ?></div>
                        </div>
                        <div class="div-table-row">
        ...
        <center>
            <div style="width:210mm; height:297mm; border:1px solid #000; margin:0px 0px 15px; padding:0px; font-size:10pt; font-family:arial; position:relative;">
                ...
                <div style="padding:5mm 15mm; text-align:left;">
                    <div class="div-table" style="margin-bottom:15px;">
                        <div class="div-table-row">
                            <div class="div-table-cell" style="width:100%"><b>Term &amp; Condition : </b></div>
                        </div>
                    </div>
                    <div class="div-table" style="margin-bottom:15px;">
                        <div class="div-table-row">
