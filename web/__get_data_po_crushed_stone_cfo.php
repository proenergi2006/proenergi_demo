<?php
$sql = "select a.*,b.nama_vendor, c.merk_dagang, d.nama_terminal, d.tanki_terminal
...
?>
                ...
                <div class="table-responsive">
                    <table class="table no-border table-detail">
                        ...
                        <tr>
                            ...
                            <td width="10">:</td>
                            <td><?php echo $data['nama_terminal']; ?> - <?php echo $data['tanki_terminal']; ?> </td>
                        </tr>
                        <tr>
                            <?php
                            ...
                            <td width="10">:</td>
                            <td> <b>Rp. <?php echo $formatted_harga_tebus ?> </b></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="10">:</td>
                            <td> <b>Rp. <?php echo $formatted_subtotal ?><b></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="10">:</td>
                            <td> <b>Rp. <?php echo $formatted_ppn11 ?></b></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="10">:</td>
                            <td><b>Rp. <?php echo  $formatted_total_order ?></b></td>
                        </tr>
        ...
        <?php if (count($res) > 0) { ?>
            <?php if (!$fnr) { ?>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-sm-top kembalikan-cfo <?php echo (!$fnr) ? 'disabled' : ''; ?>">
                        <label>Catatan Di kembalikan</label>
        ...
        <div class="form-group row persetujuan-ceo <?php echo (!$fnr) ? 'hide' : ''; ?>">
            <div class="col-sm-6">
                ...
                <?php if ($data['cfo_result'] == 0) { ?>
                    <label>Catatan CFO</label>
                    <textarea name="summary" id="summary" class="form-control"></textarea>
                <?php } elseif ($data['cfo_result'] == 1 && $data['revert_cfo'] == 0) { ?>
                    <label>Catatan CFO</label>
        ...
        <div class="form-group row persetujuan-ceo2 <?php echo (!$fnr) ? 'hide' : ''; ?>">
            <div class="col-sm-6">
                <?php if ($data['ceo_result'] == 1 && $data['revert_ceo'] == 0) { ?>
        ...
        <?php if (count($res) > 0) { ?>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <a class="btn btn-default jarak-kanan" href="<?php echo BASE_URL_CLIENT . "/verifikasi-po-crushed-stone.php"; ?>">Kembali</a>
                    <?php if ($data['cfo_result'] == 0) { ?>
