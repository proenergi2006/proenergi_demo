...
<div class="row">
    ...
    (
        ...
        WHERE 
            MONTH(a1.tanggal_loaded) = '01' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
    ...
    (
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '02' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_februari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '03' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_maret,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '04' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_april,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '05' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_mei,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '06' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_juni,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '07' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_juli,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '08' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_agustus,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '09' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_september,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '10' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_oktober,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '11' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_november,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '12' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 7
            AND c1.id_master = c.id_master
    ) AS source_desember
FROM 
...
GROUP BY 
    ...
    (
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '01' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_januari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '02' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_februari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '03' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_maret,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '04' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_april,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '05' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_mei,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '06' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_juni,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '07' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_juli,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '08' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_agustus,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '09' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_september,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '10' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_oktober,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '11' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_november,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '12' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 5
            AND c1.id_master = c.id_master
    ) AS source_desember
FROM 
    pro_master_terminal c
...
";
    ...
    (
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '01' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_januari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '02' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_februari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '03' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_maret,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '04' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_april,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '05' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_mei,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '06' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_juni,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '07' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_juli,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '08' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_agustus,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '09' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_september,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '10' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_oktober,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '11' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_november,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '12' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 3
            AND c1.id_master = c.id_master
    ) AS source_desember
FROM 
    pro_master_terminal c
...
";
    ...
    (
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '01' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_januari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '02' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_februari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '03' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_maret,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '04' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_april,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '05' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_mei,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '06' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_juni,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '07' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_juli,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '08' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_agustus,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '09' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_september,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '10' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_oktober,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '11' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_november,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '12' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 6
            AND c1.id_master = c.id_master
    ) AS source_desember
FROM 
    pro_master_terminal c
...
";
    ...
    (
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '01' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_januari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '02' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_februari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '03' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_maret,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '04' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_april,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '05' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_mei,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '06' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_juni,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '07' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_juli,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '08' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_agustus,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '09' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_september,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '10' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_oktober,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '11' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_november,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '12' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 4
            AND c1.id_master = c.id_master
    ) AS source_desember
FROM 
    pro_master_terminal c
...
";
    ...
    (
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '01' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_januari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '02' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_februari,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '03' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_maret,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '04' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_april,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '05' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_mei,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '06' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_juni,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '07' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_juli,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '08' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_agustus,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '09' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_september,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '10' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_oktober,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '11' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_november,
    (
        SELECT 
        ...
        JOIN 
            pro_po_detail d1 ON a1.id_pod = d1.id_pod 
        WHERE 
            MONTH(a1.tanggal_loaded) = '12' AND YEAR(a1.tanggal_loaded) = '2024' AND b1.id_wilayah = 2
            AND c1.id_master = c.id_master
    ) AS source_desember
FROM 
    pro_master_terminal c
