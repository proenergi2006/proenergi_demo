<?php
    ...
    if (isset($enk['idr']) && $enk['idr']!== ''){
        ...
        $sql = "select * from acl_role where id_role = '".$idr."';";
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <form action="<?php echo ACTION_CLIENT.'/acl-roles.php'; ?>" id="gform_3" name="gform_3" method="post" class="form-validasi" role="form">
                                <div class="form-group clearfix">
                                    <div class="col-sm-6">
                                        <label>Role Name *</label>
                                        <input type="text" id="role_name" name="role_name" class="form-control validate[required]" value="<?php echo $rsm['role_name'];?>" />
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <div class="col-sm-6">
                                        <label>Role Description *</label>
                                        <input type="text" id="role_desc" name="role_desc" class="form-control validate[required]" value="<?php echo $rsm['role_desc'];?>" />
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <div class="col-sm-6">
