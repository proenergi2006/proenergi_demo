        ...
        <aside class="right-side">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <div class="col-sm-12">
                    		<button type="submit" class="btn btn-info" name="btnSearch" id="btnSearch">
                            <i class="fa fa-search" style="margin-right:5px;"></i>Search</button>
						</div>
					</div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <div class="row">
                            	<div class="col-sm-6">
                                    <a href="<?php echo BASE_URL_CLIENT.'/add-master-volume.php'; ?>" class="btn btn-primary">
                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="70%">JENIS VOLUME</th>
...
$(document).ready(function(){
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/master-volume.php",
