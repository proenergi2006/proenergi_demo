                ...
                <div class="col-sm-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <div class="row">
                            	<div class="col-sm-6">
                                    <a href="<?php echo BASE_URL_CLIENT.'/permintaan-penawaran-add.php'; ?>" class="btn btn-primary">
                            ...
                            <table class="table table-bordered table-hover" id="table-grid">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="21%">Judul</th>
                                        <th class="text-center" width="15%">Tanggal</th>
                                        <th class="text-center" width="15%">Pihak Pro Energi</th>
...
$(document).ready(function(){
	$("#table-grid").ajaxGrid({
		url	 : "./datatable/permintaan-penawaran.php",
		data : {q1 : $("#q1").val()},
	});
