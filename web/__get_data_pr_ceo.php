		...
		<div class="table-responsive-satu">
			<table class="table table-bordered" id="table-grid3">
				...
				<tbody>
					...
					$fnr = ($res[0]['coo_result'] ? $res[0]['coo_result'] : $res[0]['ceo_result']);
					$fnr = ($fnr ? $fnr : null);
					...
					?>
							<tr>
								...
								<td class="text-left">
									...
									<p style="margin-bottom:0px"><?php echo ($data['nomor_lo_pr'] ? $data['nomor_lo_pr'] : 'N/A'); ?>
									</p>
								</td>
							</tr>
					<?php }
...
<!-- <div class="form-group row persetujuan-ceo <?php echo (!$fnr) ? 'hide' : ''; ?>">
	<div class="col-sm-6">
		...
		<?php } else { ?>
			<div class="form-control" style="height:auto">
				<?php echo ($res[0]['coo_summary'] ? $res[0]['coo_summary'] : $res[0]['ceo_summary']); ?>
				<?php
				$picnya = ($res[0]['coo_pic'] ? $res[0]['coo_pic'] : $res[0]['ceo_pic']);
				$tglnya = ($res[0]['coo_tanggal'] ? $res[0]['coo_tanggal'] : $res[0]['ceo_tanggal']);
				?>
