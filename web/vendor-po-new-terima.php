		...
		<aside class="right-side">
			...
			<section class="content">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hovera" id="table-grid2">
						...
						<tbody>
							...
							from new_pro_inventory_vendor_po_receive a 
							...
							if (count($resnya) > 0) {
								...
								foreach ($resnya as $data1) {
									...
									if ($data1['id_master']) {
										...
										$linkEdit 		= BASE_URL_CLIENT . '/vendor-po-new-terima-add.php?' . paramEncrypt('idr=' . $data1['id_po_supplier'] . '&idnya02=' . $data1['id_po_receive']);
								...
								<tr data-id="' . $nom . '">
									...
									<td class="text-right">' . number_format($data1['volume_bol']) . ' Liter</td>

									<td class="text-right">' . number_format($data1['volume_terima']) . ' Liter</td>
								...
								<td class="text-right"><strong>' . number_format($totalVolumeTerima) . ' Liter</strong></td>
								<td colspan="2"></td>
							  </tr>';
							} else {
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hovera" id="table-grid2">
						...
						<tbody>
							...
							$sqlnya1 = "
							select *
							from new_pro_inventory_gain_loss 
						...
						";
							...
							if (count($resnya) > 0) {
								...
								<tr data-id="' . $nom . '">
									...
									<td class="text-right">' . number_format($data1['volume']) . ' Liter</td>
				...
				<?php } elseif ($totalVolumeTerima >= $dt11) { ?>
					<div style="margin: 15px 0px;">
						<a href="<?php echo BASE_URL_CLIENT . '/vendor-po-loss-gain.php?' . paramEncrypt('idr=' . $idr); ?>" class="btn btn-success">
