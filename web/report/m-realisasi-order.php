...
$linkEx = BASE_URL_CLIENT . '/report/m-realisasi-order-exp.php';
...
<body class="skin-blue fixed">
                                    ...
                                    <div class="table-responsive">
                                        <table border="0" cellpadding="0" cellspacing="0" class="table no-border col-sm-top table-pencarian" style="margin-bottom:0px;">
                                            <tr>
                                                ...
                                                <td width="38%">
                                                    <input type="text" name="q1" id="q1" class="datepicker input-cr-sm" value="<?php echo (isset($q1) ? $q1 : ''); ?>" autocomplete="off" /> s/d
                                                    <input type="text" name="q2" id="q2" class="datepicker input-cr-sm" value="<?php echo (isset($q2) ? $q2 : ''); ?>" autocomplete="off" />
                                                </td>
                                                <td width="130">Customer</td>
                                                <td width="38%"><input type="text" name="q3" id="q3" class="input-cr-lg" value="<?php echo (isset($q3) ? $q3 : ''); ?>" /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            if (in_array($sesRole, array("5", "6", "16"))) {
                                                $agc = ($sesRole == 6 ? " and id_master != 1 and id_group_cabang = '" . $sesGrup . "'" : " and id_master != 1");
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="width:300px; float:left; margin-right:10px;">
                                                            <select name="q7" id="q7" class="select2">
                                                                ...
                                                                <?php $con->fill_select("id_master", "nama_cabang", "pro_master_cabang", $q7, "where is_active=1" . $agc, "", false); ?>
                                                            </select>
                                                        </div>
                                                    </td>
                                                    <td colspan="2">&nbsp;</td>
                                ...
                                <table class="table table-bordered col-sm-top table-isi" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="12.5%">Marketing</th>
                                            ...
                                            <?php if ($sesRole == '6') { ?>
                                                <!-- <th class="text-center" width="10%">Volume Realisasi</th> -->
                                            <?php } ?>
                                            <th class="text-center" width="8%">Harga Jual (Dasar)</th>
                                            <th class="text-center" width="6%">% Disc. Pertamina</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGrid({
                url: "./m-realisasi-order-data.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
