...
$linkEx = BASE_URL_CLIENT . '/report/f-schedule-payment-exp.php';
...
// Cek peran pengguna
$required_role = ['1', '2', '21', '4', '3', '15', '10', '11'];
...
<body class="skin-blue fixed">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>Laporan Schedule Payment</h1>
			</section>
								...
								<table class="table table-bordered col-sm-top table-isi" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="12%">Cabang Invoice</th>
											<th class="text-center" width="12%">Area</th>
											<th class="text-center" width="12%">Volume PR</th>
											<th class="text-center" width="35%">Schedule Payment</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
	...
	<script>
		$(document).ready(function() {
			...
			$("#table-grid").ajaxGrid({
				url: "./f-schedule-payment-data.php",
				data: {
					q1: $("#q1").val(),
					q2: $("#q2").val(),
					q3: $("#q3").val(),
