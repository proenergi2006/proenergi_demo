...
$linkEx = BASE_URL_CLIENT . '/report/m-customer-exp.php';
												...
												<td>
													<div style="width:300px; float:left; margin-right:10px;">
														<select name="q7" id="q7" class="select2">
															<option value="">Semua Area / All Area</option>
															<?php $con->fill_select("id_master", "nama_area", "pro_master_area", $q7, "where is_active=1", "nama_area", false); ?>
														</select>
													</div>
												</td>
											</tr>
											<?php
											if (in_array($sesRole, array("3", "4", "5", "6", "7", "10", "15", "16"))) {
												if ($sesRole == "6") {
													...
													<td>
														<div style="width:300px; float:left; margin-right:10px;">
															<select name="q6" id="q6" class="select2">
																<option></option>
																<?php $con->fill_select("id_user", "fullname", "acl_user", $q6, "where is_active=1" . $agm, "fullname", false); ?>
															</select>
														</div>
													</td>
													<?php if (in_array($sesRole, array("3", "4", "5", "6", "16"))) { ?>
														<td>Cabang Invoice</td>
														<td>
															<div style="width:300px; float:left; margin-right:10px;">
																<select name="q5" id="q5" class="select2">
																	<option value="">Semua Cabang</option>
																	<?php $con->fill_select("id_master", "nama_cabang", "pro_master_cabang", $q5, "where is_active=1" . $agc, "", false); ?>
																</select>
															</div>
														</td>
								...
								<table class="table table-bordered col-sm-top table-isi" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="18%">Marketing</th>
											<th class="text-center" width="10%">Cabang Invoice</th>
											<th class="text-center" width="10%">Area</th>
											<th class="text-center" width="10%">Status</th>
											<th class="text-center" width="14%">Volume Terkirim (Liter)</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
