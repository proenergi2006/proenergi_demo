...
<body class="skin-blue fixed">
                ...
                <form name="searchForm" id="searchForm" role="form" class="form-horizontal">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3 col-sm-top">
                            <select id="q5" name="q5" class="form-control" <?php echo ($sesrol == 10) ? 'disabled' : ''; ?>>
                                <option></option>
                    ...
                    <div class="col-sm-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body table-responsive" style="width: 100%; margin-bottom: 15px; overflow-x: auto; overflow-y: hidden;">
                                <table class="table table-bordered" id="data-rekap-performance-table">
                                    <thead>
                                        <tr>
                                            <th class="text-center" width="2%">No</th>
                                            <th class="text-center" width="3%">Month</th>
                                            <th class="text-center" width="5%">PO Date</th>
                                            <th class="text-center" width="3%">Week</th>
                                            <th class="text-center" width="5%">PO Number</th>
                                            <th class="text-center" width="5%">Qty</th>
                                            <th class="text-center" width="10%">Customer</th>
                                            <th class="text-center" width="8%">Marketing</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#data-rekap-performance-table").ajaxGrid({
                url: "./c-rekap-performance-data.php",
                data: {
                    q1: $("#q1").val(),
                    // q2: $("#q2").val(),
                    q3: $("#q3").val(),
            ...
            $('#btnExport').on('click', function() {
                let url = '<?php echo BASE_URL_CLIENT ?>/report/e-rekap-performance-xls.php?name=rekap-performance&' + $('#searchForm').serialize();
            ...
            $("#btnSearch1").on("click", function() {
                $("#data-rekap-performance-table").ajaxGrid("draw", {
                    data: {
                        q1: $("#q1").val(),
                        // q2: $("#q2").val(),
                        q3: $("#q3").val(),
            ...
            $('#tableGridLength1').on('change', function() {
                $("#data-rekap-performance-table").ajaxGrid("pageLen", $(this).val());
            });
        });
    </script>
</body>
