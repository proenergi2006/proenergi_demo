...
$linkEx = BASE_URL_CLIENT . '/report/l-loading-order-exp.php';
...
// Cek peran pengguna
$required_role = ['1', '2', '21', '4', '3', '15', '10', '9', '11', '16', '6', '5', '13'];
								...
								<form name="sFrm" id="sFrm" method="post">
									<div class="table-responsive">
										<table border="0" cellpadding="0" cellspacing="0" class="table no-border col-sm-top table-pencarian" style="margin-bottom:0px;">
											...
											<tr>
												<td>Loading Order</td>
												<td><input type="text" name="q5" id="q5" class="input-cr-lg" /></td>
												<td>No Order</td>
												<td><input type="text" name="q6" id="q6" class="input-cr-lg" /></td>
											</tr>
											<tr>
												<td>Area</td>
												<td>
													<div style="width:300px; float:left; margin-right:10px;">
														<select name="q8" id="q8" class="select2">
															...
															<?php $con->fill_select("id_master", "nama_area", "pro_master_area", $q8, "where is_active=1", "nama_area", false); ?>
														</select>
													</div>
												</td>
												<?php if (in_array($sesRole, array("3", "4", "5", "13", "15", "16"))) { ?>
								...
								<table class="table table-bordered col-sm-top table-isi" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="10%">Loading Order<br>No Order</th>
											...
											<th class="text-center" width="11%">Keterangan<br><i>(DN/ SPJ/ Segel)</i></th>
										</tr>
									</thead>
									<tbody>
									</tbody>
