...
$linkEx = BASE_URL_CLIENT . '/report/m-sales-performance-exp.php';
...
// Cek peran pengguna
$required_role = ['1', '2', '7', '21', '4', '3', '15', '10', '11', '17', '18', '6', '5'];
...
<body class="skin-blue fixed">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>Laporan Sales Performance</h1>
			</section>
			<section class="content">
								...
								<form name="sFrm" id="sFrm" method="post">
									<div class="table-responsive">
										<table border="0" cellpadding="0" cellspacing="0" class="table no-border col-sm-top table-pencarian" style="margin-bottom:0px;">
											<tr>
												<td width="130">Bulan</td>
												<td width="38%">
													<input type="text" name="q1" id="q1" class="monthpicker input-cr-sm" value="<?php echo @$q1; ?>" autocomplete="off" /> s/d
													<input type="text" name="q2" id="q2" class="monthpicker input-cr-sm" value="<?php echo @$q2; ?>" autocomplete="off" />
												</td>
												...
												<td width="38%">
													<div style="width:300px; float:left; margin-right:10px;">
														<select name="q3" id="q3" class="select2">
															<option></option>
															<?php $con->fill_select("id_master", "nama_area", "pro_master_area", $q3, "where is_active=1", "", false); ?>
														</select>
													</div>
												</td>
											</tr>
											<?php
											if (in_array($sesRole, array("3", "4", "5", "6", "7", "15", "16"))) {
												if ($sesRole == "6") {
													...
													<td>
														<div style="width:300px; float:left; margin-right:10px;">
															<select name="q4" id="q4" class="select2">
																<option></option>
																<?php $con->fill_select("id_user", "fullname", "acl_user", $q4, "where is_active=1" . $agm, "fullname", false); ?>
															</select>
														</div>
													</td>
													<td colspan="2">&nbsp;</td>
											...
											<tr>
												<td colspan="4">
													...
													<button type="button" class="btn btn-primary btn-sm" name="btnChart" id="btnChart"><i class="fa fa-bar-chart jarak-kanan"></i>Chart</button>
												</td>
											</tr>
										</table>
									</div>
				...
				<div class="row">
					<div class="col-sm-12">
								...
								<table class="table table-bordered col-sm-top table-isi" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="23%">Area</th>
											<th class="text-center" width="22%">Marketing</th>
											<th class="text-center" width="15%">Volume Terkirim (Liter)</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
						...
						<div class="box box-info content-data-chart" style="width:100%;display:none;">
							<div class="box-body table-responsive" id="data-chart">
	...
	<script>
		$(document).ready(function() {
			...
			$("#table-grid").ajaxGrid({
				url: "./m-sales-performance-data.php",
				data: {
					q1: $("#q1").val(),
					q2: $("#q2").val(),
					q3: $("#q3").val(),
			...
			$('#btnSc').on('click', function() {
				...
				$('.content-data-search').show();
				$('.content-data-chart').hide();
				return false;
			});
