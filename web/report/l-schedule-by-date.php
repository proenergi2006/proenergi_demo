...
$linkEx = BASE_URL_CLIENT . '/report/schedule-by-date-cetak.php';
...
<body class="skin-blue fixed">
                                    ...
                                    <table class="table table-bordered col-sm-top table-isi" id="table-grid">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" width="2%">Trip</th>
                                                ...
                                                <th class="text-center" width="8%">Driver </th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGrid({
                url: "./l-schedule-by-date-data.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
