                                ...
                                <table class="table table-bordered" id="data-rekap-pengiriman-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="8%">Terminal/Dispenser</th>
                                            <th class="text-center" width="8%">Nomor PO</th>
                                            <th class="text-center" width="5%">Tujuan</th>
                                            <th class="text-center" width="5%">Keterangan</th>
                                            <th class="text-center" width="5%">Qty</th>
                                            <th class="text-center" width="5%">Tanggal Potong</th>
                                            <th class="text-center" width="8%">Admin PIC</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#data-rekap-pengiriman-table").ajaxGrid({
                url: "./c-history-stock-data-operational.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
            ...
            //                 $.ajax({
            //                     type: 'POST',
            //                     url: "./c-history-stock-action-operational.php",
            //                     data: dataToSend,
            ...
            //                             }).then((result) => {
            //                                 if (result.isConfirmed) {
            //                                     window.location.href = './c-history-stock-operational.php'; // Redirect ke halaman c-history-stock
            //                                 }
            //                             });
            //                         } else {
            //                             Swal.fire({
