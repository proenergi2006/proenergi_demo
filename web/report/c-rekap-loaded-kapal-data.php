...
if ($sesrol == 10) {
    ...
    $sql = "
        ...
        JOIN pro_master_cabang i ON a.id_wilayah = i.id_master
        JOIN pro_po_customer j ON a.id_poc = j.id_poc
        JOIN pro_customer k ON j.id_customer = k.id_customer
        WHERE b.tanggal_pr > '2024-01-01' AND i.id_master = '$seswil'"; // Tambahkan kondisi untuk id_wilayah
} elseif ($sesrol == 5) {
