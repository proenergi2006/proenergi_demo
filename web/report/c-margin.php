...
$linkEx = BASE_URL_CLIENT . '/report/c-margin-exp.php';
												...
												<td>
													<div style="width:300px; float:left; margin-right:10px;">
														<select name="q5" id="q5" class="select2">
															<option></option>
															<?php $con->fill_select("id_master", "concat(jenis_produk,' - ',merk_dagang)", "pro_master_produk", $q6, "where is_active=1", "id_master", false); ?>
														</select>
													</div>
												</td>
											</tr>
												...
												<td>
													<div style="width:300px; float:left; margin-right:10px;">
														<select name="q6" id="q6" class="select2">
															<option></option>
															<?php $con->fill_select("id_master", "nama_vendor", "pro_master_vendor", $q6, "", "nama_vendor", false); ?>
														</select>
													</div>
												</td>
												<td colspan="2">&nbsp;</td>
								...
								<table class="table table-bordered col-sm-top table-isi" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="12%">Volume Realisasi</th>
											<th class="text-center" width="8%">PBBKB</th>
											<th class="text-center" width="12%">Suplier</th>
											<th class="text-center" width="12%">Nett Profit</th>
											<th class="text-center" width="19%">Loading Order/ Depot</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
