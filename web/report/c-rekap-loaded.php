                                ...
                                <table class="table table-bordered" id="data-rekap-pengiriman-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="8%">Transportir</th>
                                            <th class="text-center" width="8%">Spj</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnExport').on('click', function() {
                let url = '<?php echo BASE_URL_CLIENT ?>/report/e-rekap-loaded-xls.php?name=rekap-loaded&' + $('#searchForm').serialize();
