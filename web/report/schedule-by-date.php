...
<div style="width:100%;">
    ...
    <div style="width:33%; float:left;">
        <div style="padding:0;">
            <p style="margin:0 0 5px; text-align:center; font-size:14pt; font-family:times;"><b>Loading Schedule</b></p>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabel_rincian" style="margin-bottom:10px;">
    <tr>
        ...
        <th align="center" class="b1 b3 b4" width="3%">Trip</th>
        ...
        <th align="center" class="b1 b3 b4" width="15%">Driver</th>
    ...
    ?>
        <tr>
            ...
            <td class="b3 b4" align="center"><?php echo $data['trip_po']; ?></td>
            <td class="b3 b4" align="left"><?php echo date("d/m/Y", strtotime($data['tanggal_loading'])); ?></td>
            <td class="b3 b4" align="left"><?php echo $terminal; ?>
            </td>
            <td class="b3 b4" align="left"><?php echo $data['nama_suplier']; ?></td>
            <td class="b3 b4" align="left"><?php echo $data['nomor_plat']; ?></td>
            <td class="b3 b4" align="left"><?php echo $data['nama_sopir']; ?></td>
            <td class="b3 b4" align="right"><?php echo $volume; ?></td>
            <td class="b2 b3 b4" align="center"><?php echo $data['remark_depo']; ?></td>
        </tr>
    <?php } ?>
    <tr>
