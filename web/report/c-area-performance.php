...
$linkEx = BASE_URL_CLIENT . '/report/c-area-performance-exp.php';
...
<body class="skin-blue fixed">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>Laporan Area Performance</h1>
			</section>
			<section class="content">
				...
				<div class="row">
					<div class="col-sm-10 col-md-8">
								...
								<table class="table table-bordered col-sm-top table-isi" id="table-grid">
									<thead>
										<tr>
											...
											<th class="text-center" width="50%">Area</th>
											<th class="text-center" width="30%">Volume Delivery (Liter)</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
						...
						<div class="box box-info content-data-chart" style="max-width:100%;display:none;">
	...
	<script>
		$(document).ready(function() {
			...
			$("#table-grid").ajaxGrid({
				url: "./c-area-performance-data.php",
				data: {
					q1: $("#q1").val(),
					q2: $("#q2").val(),
					q3: $("#q3").val()
