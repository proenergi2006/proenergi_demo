...
$linkEx = BASE_URL_CLIENT . '/report/m-new-customer-exp.php';
...
include_once($public_base_directory . "/web/__get_new_customer.php");
...
<body class="skin-blue fixed">
                            ...
                            <div class="col-sm-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body table-responsive">
                                        <table class="table table-bordered table-hover" id="data-new-customer">
                                            <thead>
                                                <tr>
    ...
    <style>
        #data-new-customer td,
        #data-new-customer th {
            font-size: 12px;
        }
    ...
    <script>
        $(document).ready(function() {
            ...
            // Create the chart
            Highcharts.chart('diagram-new-customer', {
                chart: {
                    type: 'column'
                },
                credits: {
            ...
            $("#data-new-customer").ajaxGrid({
                url: "../datatable/marketing-new-customer.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val(),
            ...
            $('#btnSearch').on('click', function() {
                ...
                $("#data-new-customer").ajaxGrid("draw", {
                    data: {
                        q1: $("#q1").val(),
                        q2: $("#q2").val(),
                        q3: $("#q3").val()
                ...
                $.ajax({
                    type: "POST",
                    url: `<?= BASE_URL . "/web/__get_new_customer.php" ?>`,
                    data: {
                        "q1": valq1,
                        "q2": valq2,
                        "q3": valq3
            ...
            $('#tableGridLength').on('change', function() {
                $("#data-new-customer").ajaxGrid("pageLen", $(this).val());
            });
            ...
            $('#data-new-customer').on('click', '.openDetail', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: `<?= BASE_URL . "/web/datatable/data-detail-new-customer.php" ?>`,
                    dataType: "json",
                    data: {
                        "id_mkt": id_mkt,
                        "bulan": bulan,
                    ...
                    success: function(result) {
                        ...
                        for (var i = 0; i < result.data.length; i++) {
                            ...
                            html += "<td align='center' nowrap>" + result.data[i]['tgl_poc'] + "</td>";
                            html += "<td align='center' nowrap>" + new Intl.NumberFormat().format(result.data[i]['volume']) + "</td>";
                            html += "</tr>";
                        }
