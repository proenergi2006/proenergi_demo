<?php
	...
	$linkEx = BASE_URL_CLIENT.'/report/f-refund-exp.php';
						...
						<form name="sFrm" id="sFrm" method="post">
                            <div class="table-responsive">
                                <table border="0" cellpadding="0" cellspacing="0" class="table no-border col-sm-top table-pencarian" style="margin-bottom:0px;">
                                    <tr>
                                        <td width="130">Tgl PO</td>
                                        <td width="38%"><input type="text" name="q1" id="q1" class="datepicker input-cr-sm" value="<?php echo $q1;?>" /></td>
                                        <td width="130">Customer</td>
                                        <td width="38%"><input type="text" name="q2" id="q2" class="input-cr-lg" value="<?php echo $q2;?>" /></td>
                                    </tr>
                                    <tr>
                                        <td>Status</td>
                                        <td>
                                    ...
                                    <tr>
										...
										<?php if(in_array($sesRole, array("3", "4", "15"))){ ?>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-bordered col-sm-top table-isi" id="table-grid">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="6%">Tgl PR</th>
                                        <th class="text-center" width="19%">Kode/Nama Customer</th>
                                        <th class="text-center" width="19%">Area/Alamat Kirim</th>
                                        <th class="text-center" width="15%">No/Tgl PO</th>
                                        <th class="text-center" width="8%">Volume (Liter)</th>
                                        <th class="text-center" width="8%">Refund (Rp/liter)</th>
