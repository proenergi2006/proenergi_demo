...
<body class="skin-blue fixed">
                    ...
                    <div class="col-sm-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="<?php echo BASE_URL_CLIENT . '/add-master-harga-pertamina.php'; ?>" class="btn btn-primary">
                                ...
                                <table class="table table-bordered table-hover" id="table-grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="25%">AREA</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-grid").ajaxGrid({
                url: "./datatable/master-harga-pertamina.php",
                data: {
                    q1: $("#q1").val(),
                    q2: $("#q2").val(),
                    q3: $("#q3").val()
