        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-8">
                <div class="radio clearfix" style="margin:0px;">
                    <label class="col-xs-12" style="margin-bottom:5px;"><input type="radio" name="om_result" id="om_result1" value="1" required /> Yes</label>
                    <label class="col-xs-12" style="margin-bottom:5px;"><input type="radio" name="om_result" id="om_result2" value="2" required /> No</label>
                </div>
            </div>
        </div>
    </div>
