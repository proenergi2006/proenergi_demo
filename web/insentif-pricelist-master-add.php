<?php
    ...
    $titleAct   = "Add Tier Price List";
    $action     = "add";
    $date    = isset($_GET['d'])?$_GET['d']:tgl_indo(date('Y-m-d'),'normal','db','/');
    $dateX    = isset($_GET['d'])?$_GET['d']:tgl_indo(date('Y-m-d'),'normal','db','/');
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label>Tier *</label>
                                        <input type="text" id="tier" name="tier" class="form-control validate[required]" autocomplete = 'off' />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" id="tgl_awal" name="tgl_awal" class="form-control datepicker validate[required,custom[date]]" autocomplete = 'off' value="<?php echo $date; ?>" />
                                                <small class="text-muted">Tanggal awal</small>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>&nbsp;</label>
                                                <input type="text" id="tgl_akhir" name="tgl_akhir" class="form-control datepicker validate[required,custom[date]]" autocomplete = 'off' value="<?php echo $dateX; ?>" />
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" id="harga_awal" name="harga_awal" class="form-control hitung" value="0" autocomplete = 'off' />
                                                <small class="text-muted">Tanggal awal</small>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>&nbsp;</label>
                                                <input type="text" id="harga_akhir" name="harga_akhir" class="form-control hitung validate[required]" value="0" autocomplete = 'off' />
                                                <small class="text-muted">Tanggal akhir</small>
                                            </div>
                                        </div>
                                    </div>
