                    ...
                    <tr>
                        ...
                        <td><?php 
							if($fnr){
								...
								echo $spy;
								echo '<input type="hidden" name="cek['.$idk.']" id="cek'.$nom.'" value="1" />';
								echo '<input type="hidden" name="dt3['.$idk.']" id="dt3'.$nom.'" value="'.$data['pr_ar_notyet'].'" />';
								echo '<input type="hidden" name="dt4['.$idk.']" id="dt4'.$nom.'" value="'.$data['pr_ar_satu'].'" />';
								echo '<input type="hidden" name="dt5['.$idk.']" id="dt5'.$nom.'" value="'.$data['pr_ar_dua'].'" />';
								echo '<input type="hidden" name="dt6['.$idk.']" id="dt6'.$nom.'" value="'.$data['pr_kredit_limit'].'" />';
							}
						?></td>
                    </tr>
				<?php } } ?>
