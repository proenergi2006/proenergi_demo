...
<fieldset id="set-agreement"> 
    ...
    <div class="form-main">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="credit_limit" id="credit_limit" class="form-control angkabiasa text-right" required value="<?php echo $rsm['credit_limit'];?>" />
                    </div>
                </div>
            </div>
		</div>
        ...
        <div style="margin-bottom:0px;">
            ...
            <input type="hidden" name="idk" value="<?php echo paramEncrypt($idk);?>" />
