  ...
  <div class="column">
    <div class="column">
      <div class="note">
        ...
        <p>BotDetect allows user-defined customization of many Captcha options through a special <code>config/botdetect.xml</code> file, which should be placed in the same folder as the <code>simple-botdetect.php</code> include used by your PHP forms.</p>
        <p>Captcha settings from this configuration file will apply to all Captcha challenges shown on forms including that particular copy of <code>simple-botdetect.php</code>, and will act as defaults with which all Captcha objects will be created. This makes configuration file settings the simplest and most convenient way of Captcha customization for most use cases.</p>
        <p>The <code>lib/config/botdetect.xml</code> file used in this code example contains detailed descriptions and explanations of the many customizable Captcha options exposed by the BotDetect PHP Captcha configuration API.</p>
      </div>
    </div>
